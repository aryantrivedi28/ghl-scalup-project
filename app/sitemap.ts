...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const blogPosts: MetadataRoute.Sitemap = [
    ...
    {
      url: `${baseUrl}/blog/gohighlevel-workflow-reentry`,
      lastModified: new Date('2026-09-17'),
      changeFrequency: 'monthly',
      priority: 0.9,
    },
    {
      url: `${baseUrl}/blog/gohighlevel-enrollment-history-execution-logs`,
      lastModified: new Date('2026-09-16'),
      changeFrequency: 'monthly',
      priority: 0.9,
    },
    {
      url: `${baseUrl}/blog/gohighlevel-workflow-not-triggering`,
      lastModified: new Date('2026-09-15'),
      changeFrequency: 'monthly',
      priority: 0.9,
    },
    {
      url: `${baseUrl}/blog/gohighlevel-for-small-business`,
    ...
    {
      url: `${baseUrl}/blog/gohighlevel-website-builder`,
      lastModified: new Date('2026-07-31'),
      changeFrequency: 'monthly',
      priority: 0.8,
    },
    {
      url: `${baseUrl}/blog/gohighlevel-calendar-booking`,
    ...
    {
      url: `${baseUrl}/blog/how-to-get-first-gohighlevel-saas-clients`,
      lastModified: new Date('2026-07-25'),
      changeFrequency: 'monthly',
      priority: 0.9,  // P0 blog - high priority
    },
    {
      url: `${baseUrl}/blog/mailchimp-to-gohighlevel-migration`,
      lastModified: new Date('2026-07-22'),
      changeFrequency: 'monthly',
      priority: 0.7,  // P2 blog
    },
    {
      url: `${baseUrl}/blog/keap-to-gohighlevel-migration`,
    ...
    {
      url: `${baseUrl}/blog/a2p-brand-rejected-fix`,
    ...
    {
      url: `${baseUrl}/blog/a2p-brand-registration-guide`,
