      ...
      <div className="max-w-[1080px] mx-auto px-4 md:px-6 py-10 md:py-16">
        <div className="grid lg:grid-cols-[1fr_280px] gap-8 md:gap-16">
                    ...
                    <tr key={idx} className={`border-b border-[#DDE1E9] ${plan.popular ? 'bg-[rgba(248,208,0,0.05)]' : ''}`}>
                      <td className="py-3 px-4">
                        <span className={`text-sm font-semibold ${plan.popular ? 'text-[#F8D000]' : 'text-[#1A2236]'}`}>
                          {plan.plan} {plan.popular && <span className="text-[10px] bg-[#F8D000] text-[#0B1421] px-1.5 py-0.5 rounded ml-1">★ Popular</span>}
                        </span>
                      </td>
          ...
          <aside className="lg:sticky lg:top-24 space-y-6">
            ...
            <nav className="bg-[#F8F9FB] border border-[#DDE1E9] rounded-xl p-5">
              ...
              <ul className="space-y-1">
                {tocItems.map((item) => (
                  <li key={item.id}>
                    <button
                      onClick={() => scrollToHeading(item.id)}
                      className="block w-full text-left text-xs md:text-sm text-[#5C6880] hover:text-[#0E9BF0] transition-colors py-1.5 px-2 rounded hover:bg-white"
                    >
                      {item.title}
                    </button>
                  </li>
            ...
            {/* About the Author */}
            <div className="bg-[#0B1628] rounded-xl p-5">
            ...
            <div className="bg-white border border-[#DDE1E9] rounded-xl p-4">
              ...
              <div className="flex gap-2 flex-wrap">
                <a href="https://www.linkedin.com/company/ghl-scale-up" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-xs font-semibold bg-[#0A66C2] text-white px-3 py-1.5 rounded-md hover:opacity-85 transition-opacity">
                  <Linkedin className="w-3 h-3" />
                  LinkedIn
                </a>
                <a href="https://x.com/GHLScaleUp" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-xs font-semibold bg-black text-white px-3 py-1.5 rounded-md hover:opacity-85 transition-opacity">
