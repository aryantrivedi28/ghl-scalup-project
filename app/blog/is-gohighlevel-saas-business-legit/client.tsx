...
export default function IsGoHighLevelSAASLegitClient() {
  ...
  const ProjectHelpCard = () => (
    <div className="bg-[#0B1628] rounded-xl p-5 shadow-lg hover:shadow-xl transition-all duration-300 border border-[#2A3F5F]">
      ...
      <p className="text-[15px] text-white/60 leading-relaxed mb-4">Get quick guidance for your SaaS decision.</p>
        ...
        <div className="grid lg:grid-cols-[280px_1fr] gap-8 md:gap-12 items-start">
          ...
          <aside className="hidden lg:block lg:sticky lg:top-20 h-fit transition-all duration-300 ease-out order-1">
            ...
            <div className="bg-[#1C2E4A] rounded-xl p-5 shadow-sm hover:shadow-md transition-all duration-300 border border-[#2A3F5F] mt-4">
              <div className="text-sm font-bold text-white mb-2">Not Sure If SaaS Is Right for You?</div>
              <p className="text-xs text-white/60 leading-relaxed mb-4">We help you decide honestly, then build the technical side so you can focus on clients.</p>
              <Link href="/contact" className="flex items-center justify-center gap-2 w-full bg-[#F8D000] text-[#0B1421] font-bold py-2.5 rounded-lg text-sm hover:bg-[#FFE44D] hover:shadow-lg transition-all duration-200">
                Get Advice
                <ArrowRight className="w-3 h-3" />
              </Link>
          ...
          <main className="min-w-0 order-2">
            ...
            {/* CTA Button 3: After Risk Picture */}
            <div className="bg-gradient-to-r from-[#0B1628] to-[#1C2E4A] rounded-xl p-6 mb-8 text-center">
              <p className="text-white/80 text-sm mb-3">
                <span className="font-bold text-white">Worried about wasting your investment?</span> Let our team help you assess your risk before you commit.
              </p>
              <Link
                href="/contact"
            ...
            {/* CTA Button 4: After Saturated */}
            <div className="bg-gradient-to-r from-[#0E9BF0] to-[#0C8AD8] rounded-xl p-6 text-center text-white mb-8">
              <p className="text-sm font-medium mb-2">🔍 Not sure if your niche is too saturated?</p>
              <p className="text-sm text-white/80 mb-4">Let us review your niche idea and tell you honestly if there's room for you.</p>
              <Link
                href="/contact"
            ...
            {/* CTA Button 5: After Real Cost */}
            <div className="bg-[#1C2E4A] rounded-xl p-6 text-center text-white mb-8">
              <p className="text-sm font-medium mb-2">💰 Worried about the cost of starting?</p>
              <p className="text-sm text-white/80 mb-4">We'll help you create a realistic budget and timeline for your SaaS launch.</p>
              <Link
                href="/contact"
                className="group inline-flex items-center gap-2 bg-[#F8D000] text-[#0B1421] font-bold px-6 py-2.5 rounded-lg hover:bg-[#FFE44D] transition-all hover:shadow-lg hover:scale-105 text-sm"
              >
            ...
            <div className="bg-gradient-to-r from-[#0B1628] to-[#1C2E4A] rounded-xl p-6 text-center text-white mb-8">
              <p className="text-sm font-medium mb-2">🔍 Still not sure if a GoHighLevel SaaS business is right for you?</p>
              <p className="text-sm text-white/80 mb-4">Let us review your goals and tell you honestly if you're a good fit.</p>
              <Link
                href="/contact"
                className="group inline-flex items-center gap-2 bg-[#F8D000] text-[#0B1421] font-bold px-6 py-2.5 rounded-lg hover:bg-[#FFE44D] transition-all hover:shadow-lg hover:scale-105 text-sm"
              >
            ...
            <div className="mt-8 p-6 bg-gradient-to-br from-[#0B1628] to-[#1C2E4A] rounded-2xl text-center">
              <p className="text-white font-bold text-lg mb-2">Still Have Questions About SaaS Legitimacy?</p>
              <p className="text-white/60 text-sm mb-4">Talk to our SaaS specialists directly. We'll give you an honest answer.</p>
