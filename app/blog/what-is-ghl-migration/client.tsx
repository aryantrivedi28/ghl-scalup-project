...
export default function WhatIsGHLMigrationClient() {
  ...
  const platformData = [
    { platform: 'HubSpot', transfers: 'Contacts, deals, custom properties, tags', rebuilds: 'Workflows, email templates, forms, landing pages, company associations', guide: 'ghlscaleup.com/blog/hubspot-to-gohighlevel-migration' },
    { platform: 'ClickFunnels', transfers: 'Contacts (CSV), funnels (via GHL\'s URL import tool for visual design)', rebuilds: 'Automation sequences, Stripe connections, domain settings, Pixel tracking', guide: 'ghlscaleup.com/blog/clickfunnels-to-gohighlevel-migration' },
    { platform: 'ActiveCampaign', transfers: 'Contacts, tags, custom fields (all via CSV)', rebuilds: 'All automations, email sequences, lead scoring models, forms', guide: 'ghlscaleup.com/blog/activecampaign-to-gohighlevel-migration' },
    { platform: 'Kajabi', transfers: 'Contacts and students (CSV)', rebuilds: 'All course content (manual rebuild), email sequences, offers, community', guide: 'ghlscaleup.com/blog/kajabi-to-gohighlevel-migration' },
          ...
          <main className="min-w-0">
            ...
            <div className="bg-[#1C2E4A] rounded-xl p-5 my-6 text-white">
              ...
              <p className="text-sm text-white/80 leading-relaxed">
                Then <Link href="/contact-us" className="text-[#0E9BF0] hover:underline">book your free assessment at ghlscaleup.com/contact-us →</Link>
              </p>
            </div>
