          ...
          <main className="min-w-0 order-2">
            ...
            <div className="bg-gradient-to-br from-[#0B1628] to-[#1C2E4A] rounded-xl p-6 text-center my-6">
              <p className="text-white/80 text-sm mb-4 max-w-lg mx-auto">
                <strong className="text-white">🚀 Running an agency on GoHighLevel and not scaling?</strong>
              </p>
              <p className="text-white/60 text-sm mb-4 max-w-lg mx-auto">
                Most agency GHL accounts have no Snapshots, basic workflows, and untouched AI features. We audit and rebuild agency accounts every week.
              </p>
            ...
            {/* CTA 2 - After Onboard Clients */}
            <div className="bg-gradient-to-br from-[#1C2E4A] to-[#111E30] rounded-xl p-6 text-center my-6 text-white">
              <p className="text-sm font-medium mb-2">⏱️ Spending 8–40 hours onboarding each new client?</p>
              <p className="text-sm text-white/80 mb-4">We build production-ready Snapshots that reduce client onboarding to under an hour.</p>
              <Link href="/contact" className="inline-flex items-center gap-2 bg-[#F8D000] text-[#0B1421] font-bold px-6 py-3 rounded-lg hover:bg-[#FFE44D] transition-all">
                <Rocket className="w-4 h-4" />
                Get Your Snapshot Built
                <ArrowRight className="w-4 h-4" />
              </Link>
            </div>
            ...
            <div className="bg-[#0B1628] rounded-xl p-6 text-center my-6 text-white">
              <p className="text-sm font-medium mb-2">🔍 Not sure if your agency GHL setup is built to scale?</p>
              <p className="text-sm text-white/80 mb-4">We audit agency accounts and find issues most agencies don't know they have. Book a free audit.</p>
              <Link href="/contact" className="inline-flex items-center gap-2 bg-[#F8D000] text-[#0B1421] font-bold px-6 py-3 rounded-lg hover:bg-[#FFE44D] transition-all">
            ...
            <div className="bg-gradient-to-br from-[#0B1628] to-[#1C2E4A] rounded-xl p-6 text-center my-6">
              <p className="text-white/80 text-sm mb-4 max-w-lg mx-auto">
                <strong className="text-white">Still have questions about GoHighLevel for your agency?</strong>
              </p>
              <p className="text-white/60 text-sm mb-4 max-w-lg mx-auto">
                Talk to our agency GHL specialists directly. We've built 200+ agency systems and know what works.
              </p>
