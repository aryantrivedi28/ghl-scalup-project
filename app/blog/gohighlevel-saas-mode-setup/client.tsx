...
export default function GoHighLevelSaaSModeSetupClient() {
  ...
  const ProjectHelpCard = () => (
    <div className="bg-[#0B1628] rounded-xl p-5 shadow-lg hover:shadow-xl transition-all duration-300 border border-[#2A3F5F]">
      ...
      <p className="text-[15px] text-white/60 leading-relaxed mb-4">Get quick guidance for your SaaS Mode setup.</p>
          ...
          <main className="min-w-0 order-2">
            ...
            <div className="bg-gradient-to-r from-[#0B1628] to-[#1C2E4A] rounded-xl p-6 mb-8 text-center">
              <p className="text-white/80 text-sm mb-3">
                <span className="font-bold text-white">Want to skip the learning curve?</span> Let our team set up your SaaS Mode in 5-7 business days.
              </p>
              <Link
                href="/contact"
            ...
            {/* CTA Button 4: After Pricing Tiers */}
            <div className="bg-gradient-to-r from-[#0E9BF0] to-[#0C8AD8] rounded-xl p-6 text-center text-white mb-8">
              <p className="text-sm font-medium mb-2">💰 Not sure how to price your SaaS plans?</p>
              <p className="text-sm text-white/80 mb-4">We'll help you structure pricing that maximises revenue and client retention.</p>
              <Link
                href="/contact"
            ...
            {/* CTA Button 5: After Troubleshooting */}
            <div className="bg-[#1C2E4A] rounded-xl p-6 text-center text-white mb-8">
              <p className="text-sm font-medium mb-2">🔧 Still stuck on a setup issue?</p>
              <p className="text-sm text-white/80 mb-4">Let our team diagnose and fix your SaaS Mode configuration.</p>
              <Link
                href="/contact"
                className="group inline-flex items-center gap-2 bg-[#F8D000] text-[#0B1421] font-bold px-6 py-2.5 rounded-lg hover:bg-[#FFE44D] transition-all hover:shadow-lg hover:scale-105 text-sm"
              >
            ...
            <div className="bg-gradient-to-br from-[#1C2E4A] to-[#111E30] rounded-xl p-5 my-6 text-white">
              ...
              <Link href="/contact" className="inline-flex items-center gap-2 bg-[#F8D000] text-[#0B1421] font-bold px-5 py-2.5 rounded-lg hover:bg-[#FFE44D] transition-all text-sm">
            ...
            <div className="bg-gradient-to-r from-[#0B1628] to-[#1C2E4A] rounded-xl p-6 text-center text-white mb-8">
              <p className="text-sm font-medium mb-2">🔍 Still not sure if SaaS Mode is right for you?</p>
              <p className="text-sm text-white/80 mb-4">Let us review your agency model and tell you honestly if SaaS Mode fits.</p>
              <Link
                href="/contact"
                className="group inline-flex items-center gap-2 bg-[#F8D000] text-[#0B1421] font-bold px-6 py-2.5 rounded-lg hover:bg-[#FFE44D] transition-all hover:shadow-lg hover:scale-105 text-sm"
              >
            ...
            <div className="mt-8 p-6 bg-gradient-to-br from-[#0B1628] to-[#1C2E4A] rounded-2xl text-center">
              <p className="text-white font-bold text-lg mb-2">Still Have Questions About SaaS Mode Setup?</p>
              <p className="text-white/60 text-sm mb-4">Talk to our GHL experts directly. We've set this up for agencies in every industry.</p>
