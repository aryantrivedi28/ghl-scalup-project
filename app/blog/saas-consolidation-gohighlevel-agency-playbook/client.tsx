...
export default function SaaSConsolidationPlaybookClient() {
  ...
  const ProjectHelpCard = () => (
    <div className="bg-[#0B1628] rounded-xl p-5 shadow-lg hover:shadow-xl transition-all duration-300 border border-[#2A3F5F]">
      ...
      <p className="text-[15px] text-white/60 leading-relaxed mb-4">Get quick guidance for your SaaS consolidation.</p>
        ...
        <div className="grid lg:grid-cols-[280px_1fr] gap-8 md:gap-12 items-start">
          ...
          <aside className="hidden lg:block lg:sticky lg:top-20 h-fit transition-all duration-300 ease-out order-1">
            ...
            <div className="bg-white border border-[#DDE1E9] rounded-xl p-4 shadow-sm hover:shadow-md transition-all duration-300 mt-4">
              <div className="text-xs font-semibold text-[#5C6880] mb-3 uppercase tracking-wide">Share this playbook</div>
          ...
          <main className="min-w-0 order-2">
            ...
            <div className="bg-gradient-to-r from-[#0B1628] to-[#1C2E4A] rounded-xl p-6 mb-8 text-center">
              <p className="text-white/80 text-sm mb-3">
                <span className="font-bold text-white">Ready to turn consolidation into recurring revenue?</span> Let our team help you build the offering.
              </p>
              <Link
                href="/contact"
            ...
            {/* CTA Button 4: After Pricing */}
            <div className="bg-gradient-to-r from-[#0E9BF0] to-[#0C8AD8] rounded-xl p-6 text-center text-white mb-8">
              <p className="text-sm font-medium mb-2">💰 Not sure how to price your SaaS offering?</p>
              <p className="text-sm text-white/80 mb-4">We'll help you design pricing tiers that maximise revenue and client retention.</p>
              <Link
                href="/contact"
            ...
            <div className="bg-gradient-to-r from-[#0B1628] to-[#1C2E4A] rounded-xl p-6 text-center text-white mb-8">
              <p className="text-sm font-medium mb-2">🔍 Not sure if this shift is right for your agency?</p>
              <p className="text-sm text-white/80 mb-4">Let us review your agency model and tell you honestly if SaaS consolidation fits.</p>
              <Link
                href="/contact"
                className="group inline-flex items-center gap-2 bg-[#F8D000] text-[#0B1421] font-bold px-6 py-2.5 rounded-lg hover:bg-[#FFE44D] transition-all hover:shadow-lg hover:scale-105 text-sm"
              >
            ...
            <div className="mt-8 p-6 bg-gradient-to-br from-[#0B1628] to-[#1C2E4A] rounded-2xl text-center">
              <p className="text-white font-bold text-lg mb-2">Still Have Questions About SaaS Consolidation?</p>
              <p className="text-white/60 text-sm mb-4">Talk to our SaaS specialists directly. We've helped agencies make this shift.</p>
