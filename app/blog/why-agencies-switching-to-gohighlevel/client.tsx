          ...
          <main className="min-w-0 order-2">
            ...
            <div className="bg-gradient-to-r from-[#0B1628] to-[#1C2E4A] rounded-xl p-6 mb-8 text-center">
              <p className="text-white/80 text-sm mb-3">
                <span className="font-bold text-white">Tired of managing 8 different tools?</span> Let us show you how GHL consolidates everything.
              </p>
              <Link
                href="/contact"
            ...
            {/* CTA Button 4: After Cost Comparison */}
            <div className="bg-gradient-to-r from-[#0E9BF0] to-[#0C8AD8] rounded-xl p-6 text-center text-white mb-8">
              <p className="text-sm font-medium mb-2">Ready to stop overpaying for your tool stack?
              </p>
              <p className="text-sm text-white/80 mb-4">Let's calculate exactly how much your agency could save by switching to GHL.</p>
              <Link
                href="/contact"
            ...
            {/* CTA Button 5: After AI Features */}
            <div className="bg-[#1C2E4A] rounded-xl p-6 text-center text-white mb-8">
              <p className="text-sm font-medium mb-2">🤖 Not using GHL's AI features yet?</p>
              <p className="text-sm text-white/80 mb-4">Let us help you set up AI Voice Agent, Conversation AI, and automated workflows.</p>
              <Link
                href="/contact"
                className="group inline-flex items-center gap-2 bg-[#F8D000] text-[#0B1421] font-bold px-6 py-2.5 rounded-lg hover:bg-[#FFE44D] transition-all hover:shadow-lg hover:scale-105 text-sm"
              >
                <Zap className="w-4 h-4" />
                Activate Your AI Features
                <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
              </Link>
            </div>
            ...
            <div className="bg-[#1C2E4A] rounded-xl p-5 my-6 text-white">
              ...
              <p className="text-sm text-white/80 leading-relaxed">
                ...
                <Link href="/contact" className="text-[#0E9BF0] hover:underline ml-1">book a free strategy call →</Link>
              </p>
            </div>
            ...
            <div className="mt-8 p-6 bg-gradient-to-br from-[#0B1628] to-[#1C2E4A] rounded-2xl text-center">
              <p className="text-white font-bold text-lg mb-2">Still Have Questions About Switching?</p>
              <p className="text-white/60 text-sm mb-4">Talk to our migration specialists directly. We're here to help you make the right decision.</p>
