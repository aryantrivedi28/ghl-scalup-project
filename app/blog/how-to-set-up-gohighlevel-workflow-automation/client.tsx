...
export default function WorkflowAutomationClient() {
  ...
  const ProjectHelpCard = () => (
    <div className="bg-[#0B1628] rounded-xl p-5 shadow-lg hover:shadow-xl transition-all duration-300 border border-[#2A3F5F]">
      ...
      <p className="text-[15px] text-white/60 leading-relaxed mb-4">Get quick guidance for your workflow setup.</p>
          ...
          <main className="min-w-0 order-2">
            ...
            <div className="bg-gradient-to-r from-[#0B1628] to-[#1C2E4A] rounded-xl p-6 mb-8 text-center">
              <p className="text-white/80 text-sm mb-3">
                <span className="font-bold text-white">Ready to build your first workflow?</span> Let our team help you set it up correctly.
              </p>
              <Link
                href="/contact"
            ...
            {/* CTA Button 4: After Building Blocks */}
            <div className="bg-gradient-to-r from-[#0E9BF0] to-[#0C8AD8] rounded-xl p-6 text-center text-white mb-8">
              <p className="text-sm font-medium mb-2">⚡ Want to skip the learning curve?</p>
              <p className="text-sm text-white/80 mb-4">We'll build your workflows for you so you can start automating immediately.</p>
              <Link
                href="/contact"
            ...
            {/* CTA Button 5: After Important Workflows */}
            <div className="bg-[#1C2E4A] rounded-xl p-6 text-center text-white mb-8">
              <p className="text-sm font-medium mb-2">⚡ Need these 3 workflows built for you?</p>
              <p className="text-sm text-white/80 mb-4">We'll set up your most important automations so you can start saving time immediately.</p>
              <Link
                href="/contact"
                className="group inline-flex items-center gap-2 bg-[#F8D000] text-[#0B1421] font-bold px-6 py-2.5 rounded-lg hover:bg-[#FFE44D] transition-all hover:shadow-lg hover:scale-105 text-sm"
              >
            ...
            <div className="bg-gradient-to-r from-[#0B1628] to-[#1C2E4A] rounded-xl p-6 text-center text-white mb-8">
              <p className="text-sm font-medium mb-2">⚠️ Don't make costly workflow mistakes.</p>
              <p className="text-sm text-white/80 mb-4">Get a free, no-obligation workflow audit from experts who've built 200+ GHL systems.</p>
              <Link
                href="/contact"
                className="group inline-flex items-center gap-2 bg-[#F8D000] text-[#0B1421] font-bold px-6 py-2.5 rounded-lg hover:bg-[#FFE44D] transition-all hover:shadow-lg hover:scale-105 text-sm"
              >
            ...
            <div className="mt-8 p-6 bg-gradient-to-br from-[#0B1628] to-[#1C2E4A] rounded-2xl text-center">
              <p className="text-white font-bold text-lg mb-2">Still Have Questions About Workflows?</p>
              <p className="text-white/60 text-sm mb-4">Talk to our workflow specialists directly. We've built 200+ automation systems.</p>
