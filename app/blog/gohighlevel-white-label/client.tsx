...
export default function GoHighLevelWhiteLabelClient() {
  ...
  const ProjectHelpCard = () => (
    <div className="bg-[#0B1628] rounded-xl p-5 shadow-lg hover:shadow-xl transition-all duration-300 border border-[#2A3F5F]">
      ...
      <p className="text-[15px] text-white/60 leading-relaxed mb-4">Get quick guidance for your white label setup.</p>
      ...
      <section className="bg-[#0B1628] py-12 md:py-[72px] px-4 md:px-6 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <h1 className="text-[clamp(28px,6vw,46px)] font-extrabold leading-[1.2] md:leading-[1.15] text-white mb-4 md:mb-5 tracking-[-0.02em]">
            ...
            <span className="text-[#F8D000]">How to Brand GoHighLevel as Your Own</span>
          </h1>
          ...
          {/* Direct Answer Box */}
          <div className="bg-[rgba(14,155,240,0.1)] border border-[rgba(14,155,240,0.2)] rounded-xl p-4 mt-4 max-w-6xl">
      ...
      <div className="max-w-[1280px] mx-auto px-4 md:px-6 py-10 md:py-10">
        <div className="grid lg:grid-cols-[280px_1fr] gap-8 md:gap-12 items-start">
          ...
          <main className="min-w-0 order-2">
            ...
            {/* What This Guide Covers - Mobile TOC */}
            ...
            {/* CTA Button 2: After Section 1 */}
            <div className="bg-gradient-to-r from-[#0B1628] to-[#1C2E4A] rounded-xl p-6 mb-8 text-center">
              <p className="text-white/80 text-sm mb-3">
                <span className="font-bold text-white">Ready to brand GoHighLevel as your own?</span> Let our team handle the setup.
              </p>
              <Link
                href="/contact"
            ...
            {/* CTA Button 3: After Which Plan */}
            <div className="bg-gradient-to-r from-[#0E9BF0] to-[#0C8AD8] rounded-xl p-6 text-center text-white mb-8">
              <p className="text-sm font-medium mb-2">🤔 Not sure which plan you need?</p>
              <p className="text-sm text-white/80 mb-4">Let us review your agency model and recommend the right plan.</p>
              <Link
                href="/contact"
            ...
            {/* CTA Button 4: After Setup Steps */}
            <div className="bg-[#1C2E4A] rounded-xl p-6 text-center text-white mb-8">
              <p className="text-sm font-medium mb-2">⚡ Don't want to deal with DNS and SSL setup yourself?</p>
              <p className="text-sm text-white/80 mb-4">We configure your white-label domain, SSL, branding, and notifications.</p>
              <Link
                href="/contact"
                className="group inline-flex items-center gap-2 bg-[#F8D000] text-[#0B1421] font-bold px-6 py-2.5 rounded-lg hover:bg-[#FFE44D] transition-all hover:shadow-lg hover:scale-105 text-sm"
              >
            ...
            {/* CTA Button 5: After SaaS Business */}
            <div className="bg-gradient-to-r from-[#0B1628] to-[#1C2E4A] rounded-xl p-6 text-center text-white mb-8">
              <p className="text-sm font-medium mb-2">🚀 Ready to turn your white label into a SaaS business?</p>
              <p className="text-sm text-white/80 mb-4">We configure the full SaaS Mode setup including Stripe, pricing tiers, and automated provisioning.</p>
              <Link
                href="/contact"
                className="group inline-flex items-center gap-2 bg-[#F8D000] text-[#0B1421] font-bold px-6 py-2.5 rounded-lg hover:bg-[#FFE44D] transition-all hover:shadow-lg hover:scale-105 text-sm"
              >
            ...
            {/* CTA Button 6: After Troubleshooting */}
            <div className="bg-gradient-to-r from-[#0B1628] to-[#1C2E4A] rounded-xl p-6 text-center text-white mb-8">
              <p className="text-sm font-medium mb-2">🔧 Still stuck on domain or SSL issues?</p>
              <p className="text-sm text-white/80 mb-4">Let our team diagnose and fix your white label configuration.</p>
              <Link
                href="/contact"
                className="group inline-flex items-center gap-2 bg-[#F8D000] text-[#0B1421] font-bold px-6 py-2.5 rounded-lg hover:bg-[#FFE44D] transition-all hover:shadow-lg hover:scale-105 text-sm"
              >
            ...
            <div className="bg-gradient-to-r from-[#0B1628] to-[#1C2E4A] rounded-xl p-6 text-center text-white mb-8">
              <p className="text-sm font-medium mb-2">⚠️ Don't make costly white label mistakes.</p>
              <p className="text-sm text-white/80 mb-4">Get a free, no-obligation white label assessment from experts who've built hundreds of GHL setups.</p>
              <Link
                href="/contact"
                className="group inline-flex items-center gap-2 bg-[#F8D000] text-[#0B1421] font-bold px-6 py-2.5 rounded-lg hover:bg-[#FFE44D] transition-all hover:shadow-lg hover:scale-105 text-sm"
              >
            ...
            <div className="mt-8 p-6 bg-gradient-to-br from-[#0B1628] to-[#1C2E4A] rounded-2xl text-center">
              <p className="text-white font-bold text-lg mb-2">Still Have Questions About White Label?</p>
              <p className="text-white/60 text-sm mb-4">Talk to our white label specialists directly. We've set this up for 200+ businesses.</p>
