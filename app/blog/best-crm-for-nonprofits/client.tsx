          ...
          <main className="min-w-0 order-2">
            ...
            <div className="bg-[#F8F9FB] border border-[#DDE1E9] rounded-xl p-5 md:p-6 mb-8">
              ...
              <div className="mt-4 pt-4 border-t border-[#DDE1E9]">
                ...
                >
                  ...
                  Get Your Nonprofit CRM Assessment
            ...
            <div className="bg-gradient-to-br from-[#0B1628] to-[#1C2E4A] rounded-xl p-6 text-center my-6">
              ...
              <p className="text-white/60 text-sm mb-4 max-w-lg mx-auto">
                Get a free strategy call to discuss your nonprofit's specific needs and find the right CRM fit.
              </p>
            ...
            <div className="bg-gradient-to-br from-[#1C2E4A] to-[#111E30] rounded-xl p-6 text-center my-6 text-white">
              <p className="text-sm font-medium mb-2">See how a structured GHL CRM setup can map your nonprofit's processes into pipelines, fields and permissions.</p>
            ...
            <div className="bg-gradient-to-br from-[#0B1628] to-[#1C2E4A] rounded-xl p-6 text-center my-6">
              <p className="text-white/80 text-sm mb-4 max-w-lg mx-auto">
                <strong className="text-white">Still have questions about nonprofit CRM selection?</strong>
              </p>
              <p className="text-white/60 text-sm mb-4 max-w-lg mx-auto">
                Talk to our nonprofit CRM specialists directly. We've helped nonprofits choose and implement the right CRM for their mission.
              </p>
