...
export const metadata: Metadata = {
  title: 'GHL Migration Timeline: How Long Does It Take? (2026)',
  description: 'Simple migration: 1 to 2 weeks. Complex: 6 to 8 weeks. Timeline driven by automation count, not contact volume. Full breakdown.',
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            "headline": "GHL Migration Timeline: How Long Does It Take? (2026)",
