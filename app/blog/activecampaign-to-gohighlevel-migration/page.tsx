...
export const metadata: Metadata = {
  title: 'ActiveCampaign to GoHighLevel Migration: What Transfers & Breaks',
  description: 'See what transfers from ActiveCampaign to GoHighLevel and what must be rebuilt, including automations, lead scoring, list mapping, workflows, and email deliverability.',
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Article",
            "headline": "ActiveCampaign to GoHighLevel Migration: What Transfers & Breaks",
