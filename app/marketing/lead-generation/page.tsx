...
export default function LeadGenerationPage() {
  return (
    <>
      <Breadcrumb items={[{ label: 'Marketing Services', href: '/marketing' }, { label: 'Lead Generation Systems' }]} />
      ...
      <section className="py-16 md:py-20 bg-[#F4F7FA]">
        <div className="max-w-[1200px] mx-auto px-4 md:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-5">
            {[
              { title: 'CRM Setup', description: 'Capture and manage leads effectively with a properly configured GHL CRM system.', href: '/services/crm-setup' },
              { title: 'Workflow Automation', description: 'Automate follow-up sequences that nurture leads until they\'re ready to buy.', href: '/services/workflow-automation' },
              { title: 'Email Marketing', description: 'Advanced email campaigns that engage leads and drive conversions.', href: '/marketing/email-marketing' },
            ].map((service, index) => (
