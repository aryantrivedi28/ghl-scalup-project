...
export const metadata: Metadata = {
  title: 'Best Way to Set Up Missed Call Text Back Without Changing Your Number',
  description: 'The best way to set up missed call text back is Conditional Call Forwarding — keeps your number, rings normally, routes to GoHighLevel only when missed.',
  keywords: 'missed call text back, conditional call forwarding, GoHighLevel setup, business phone setup, call forwarding setup',
  alternates: {
    canonical: 'https://www.ghlscaleup.com/missed-call-text-back-setup',
  },
  openGraph: {
    title: 'Best Way to Set Up Missed Call Text Back Without Changing Your Number',
    description: 'The best way to set up missed call text back is Conditional Call Forwarding — keeps your number, rings normally, routes to GoHighLevel only when missed.',
    url: 'https://www.ghlscaleup.com/missed-call-text-back-setup',
  ...
  twitter: {
    ...
    title: 'Best Way to Set Up Missed Call Text Back Without Changing Your Number',
    description: 'The best way to set up missed call text back is Conditional Call Forwarding — it keeps your business phone number, rings normally, and only routes to GoHighLevel when a call is missed.',
  },
};
  ...
  return (
    <>
      ...
      <div className="max-w-[760px] mx-auto px-4 sm:px-6 py-8 sm:py-12 md:py-16">
        ...
        <ul className="list-disc pl-5 space-y-1 text-sm sm:text-base text-[#333] mb-6">
        ...
        <p className="text-sm sm:text-base text-[#333] leading-relaxed mb-2">
            ...
            <table className="w-full border-collapse text-xs sm:text-sm">
              <thead>
                <tr className="bg-[#1C2E4A]">
                  <th className="text-left py-2 px-2 sm:px-3 text-white font-semibold">Carrier</th>
                  <th className="text-left py-2 px-2 sm:px-3 text-white font-semibold">Turn on</th>
                  <th className="text-left py-2 px-2 sm:px-3 text-white font-semibold">Turn off</th>
                </tr>
              </thead>
              <tbody>
                {carrierCodes.map((item, idx) => (
                  <tr key={idx} className="border-b border-[#E0E4EA]">
                    <td className="py-2 px-2 sm:px-3 font-medium text-[#1C2E4A] whitespace-nowrap">{item.carrier}</td>
                    <td className="py-2 px-2 sm:px-3 text-[#0E9BF0] font-mono text-xs sm:text-sm break-all">{item.turnOn}</td>
                    <td className="py-2 px-2 sm:px-3 text-[#667] font-mono text-xs sm:text-sm break-all">{item.turnOff}</td>
                  </tr>
                ))}
              </tbody>
            </table>
