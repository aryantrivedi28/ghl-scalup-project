      ...
      <section className="bg-gradient-to-b from-[#1C2E4A] to-[#111E30] text-white py-16 md:py-20 relative overflow-hidden">
        ...
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 md:px-8 relative z-10">
          <div className="text-center max-w-[720px] mx-auto">
            ...
            <h1 className="text-[clamp(1.8rem,4vw,3rem)] font-extrabold tracking-[-0.04em] leading-[1.2] md:leading-[1.05] mb-4">
              The People Behind Your<br />
              <span className="text-[#F8D000]">GoHighLevel Growth</span>
            </h1>
            <p className="text-sm sm:text-base font-light text-white/55 leading-relaxed max-w-[560px] mx-auto px-4 sm:px-0">
        ...
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 md:px-8">
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
            <div className="fade-in order-2 md:order-1">
              ...
              <h2 className="text-[clamp(1.4rem,3vw,2rem)] lg:text-[clamp(1.6rem,3vw,2.2rem)] font-extrabold tracking-[-0.03em] leading-[1.3] md:leading-[1.12] mb-4 text-[#1C2E4A]">
                How a Frustration with<br />
                <span className="text-[#0E9BF0]">Broken GHL Setups</span> Became a Business
              </h2>
              <p className="text-sm sm:text-[0.9rem] font-light text-[#4A5568] leading-relaxed mb-4">
            ...
            <div className="fade-in order-1 md:order-2">
              <div className="bg-[#1C2E4A] rounded-2xl p-6 sm:p-8 md:p-10 text-white relative overflow-hidden">
                <div className="absolute right-[-10px] bottom-[-20px] text-6xl sm:text-7xl md:text-8xl font-black text-white/5 tracking-[-0.05em] pointer-events-none">
                  GHL
                </div>
                <blockquote className="text-[0.9rem] sm:text-[1rem] md:text-[1.05rem] italic font-normal text-white/75 leading-relaxed border-l-4 border-[#F8D000] pl-4 sm:pl-5 mb-4 sm:mb-5 relative z-10">
                ...
                <div className="flex flex-col gap-0 mt-6 relative z-10">
                  {[
                    ...
                    <div key={idx} className="flex gap-3 py-2.5 border-t border-white/10">
                      <div className="text-[0.7rem] sm:text-[0.75rem] font-extrabold text-[#F8D000] min-w-[50px]">{item.year}</div>
      ...
      <div className="bg-[#0B1421] py-8 md:py-10">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 md:px-8">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6 text-center">
            <div>
              <div className="text-xl sm:text-2xl md:text-[2.2rem] font-black text-[#F8D000] tracking-[-0.04em] leading-none">200+</div>
              <div className="text-[0.65rem] sm:text-[0.7rem] md:text-[0.72rem] text-[#8A9BB0] font-medium mt-1.5 uppercase tracking-[0.05em]">GHL Projects</div>
            </div>
            <div>
              <div className="text-xl sm:text-2xl md:text-[2.2rem] font-black text-[#F8D000] tracking-[-0.04em] leading-none">50+</div>
              <div className="text-[0.65rem] sm:text-[0.7rem] md:text-[0.72rem] text-[#8A9BB0] font-medium mt-1.5 uppercase tracking-[0.05em]">Active Clients</div>
            </div>
            <div>
              <div className="text-xl sm:text-2xl md:text-[2.2rem] font-black text-[#F8D000] tracking-[-0.04em] leading-none">6</div>
              <div className="text-[0.65rem] sm:text-[0.7rem] md:text-[0.72rem] text-[#8A9BB0] font-medium mt-1.5 uppercase tracking-[0.05em]">Countries</div>
            </div>
            <div>
              <div className="text-xl sm:text-2xl md:text-[2.2rem] font-black text-[#F8D000] tracking-[-0.04em] leading-none">5+</div>
              <div className="text-[0.65rem] sm:text-[0.7rem] md:text-[0.72rem] text-[#8A9BB0] font-medium mt-1.5 uppercase tracking-[0.05em]">Years on GHL</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-white">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 md:px-8">
          <div className="grid md:grid-cols-[0.85fr_1.15fr] gap-8 md:gap-12 lg:gap-14 items-center">
            <div className="relative fade-in order-1 md:order-1">
              ...
              <div className="absolute bottom-2 right-2 sm:bottom-3 md:bottom-5 bg-[#F8D000] text-[#0B1421] px-3 py-1.5 sm:px-4 sm:py-2 md:px-5 md:py-3 rounded-xl text-[0.6rem] sm:text-[0.68rem] md:text-[0.72rem] font-bold shadow-lg whitespace-nowrap">
                Founder & CEO
              </div>
            </div>
            <div className="fade-in order-2 md:order-2">
              ...
              <div className="text-[1.4rem] sm:text-[1.6rem] md:text-[1.8rem] font-extrabold text-[#1C2E4A] tracking-[-0.03em] mb-1">Aryan Trivedi</div>
              <div className="text-[0.75rem] sm:text-[0.8rem] md:text-[0.85rem] font-medium text-[#0E9BF0] mb-4 md:mb-5">Founder & CEO, GHL Scale Up</div>
              <p className="text-sm sm:text-[0.85rem] md:text-[0.9rem] font-light text-[#4A5568] leading-relaxed mb-3">
              ...
              <div className="flex gap-2.5 mt-5">
                <Link href="#" className="w-8 h-8 rounded-lg bg-[#F4F7FA] border border-[#E8EDF4] flex items-center justify-center text-[0.7rem] font-semibold text-[#4A5568] hover:bg-[#0E9BF0] hover:text-white transition-all">in</Link>
                <Link href="#" className="w-8 h-8 rounded-lg bg-[#F4F7FA] border border-[#E8EDF4] flex items-center justify-center text-[0.7rem] font-semibold text-[#4A5568] hover:bg-[#0E9BF0] hover:text-white transition-all">X</Link>
                <Link href="mailto:aryan@ghlscaleup.com" className="w-8 h-8 rounded-lg bg-[#F4F7FA] border border-[#E8EDF4] flex items-center justify-center text-[0.7rem] font-semibold text-[#4A5568] hover:bg-[#0E9BF0] hover:text-white transition-all">✉</Link>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-[#F4F7FA]">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 md:px-8">
          <div className="text-center max-w-[700px] mx-auto mb-8 md:mb-12 fade-in">
            ...
            <h2 className="text-[clamp(1.4rem,3vw,2rem]] lg:text-[clamp(1.6rem,3vw,2.2rem)] font-extrabold tracking-[-0.03em] leading-[1.3] mb-3 text-[#1C2E4A]">
            ...
            {coreTeam.map((member, index) => (
              <div key={index} className="bg-white border border-[#E8EDF4] rounded-2xl overflow-hidden hover:-translate-y-1.5 hover:shadow-[0_16px_48px_rgba(28,46,74,0.1)] hover:border-[#0E9BF0] transition-all fade-in">
                ...
                <div className="p-5 md:p-6 text-center">
                  <div className="text-base md:text-[1.05rem] font-bold text-[#1C2E4A] mb-1">{member.name}</div>
                  <div className="text-[0.7rem] md:text-[0.78rem] font-medium text-[#0E9BF0] mb-3">{member.role}</div>
                  <p className="text-[0.75rem] md:text-[0.82rem] font-light text-[#4A5568] leading-relaxed line-clamp-4">{member.bio}</p>
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-white">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 md:px-8">
            ...
            {experts.map((expert, index) => (
              <div key={index} className="bg-white border border-[#E8EDF4] rounded-2xl overflow-hidden hover:-translate-y-1.5 hover:shadow-[0_16px_48px_rgba(28,46,74,0.1)] hover:border-[#F8D000] transition-all fade-in">
                ...
                <div className="p-4 md:p-5">
                  <div className="text-[0.85rem] md:text-[0.95rem] font-bold text-[#1C2E4A] mb-0.5">{expert.name}</div>
                  <div className="text-[0.6rem] md:text-[0.72rem] font-semibold text-[#F8D000] uppercase tracking-[0.06em] mb-2">{expert.role}</div>
                  <p className="text-[0.7rem] md:text-[0.78rem] font-light text-[#4A5568] leading-relaxed mb-2.5 line-clamp-3">{expert.bio}</p>
                  {expert.results && expert.results.length > 0 && (
                    <div className="flex flex-col gap-1.5 mb-2.5 pt-2 border-t border-[#E8EDF4]">
                      {expert.results.slice(0, 2).map((result, idx) => (
                        <div key={idx} className="text-[0.6rem] md:text-[0.7rem] font-normal text-[#4A5568] flex gap-1.5">
                  ...
                  <div className="flex flex-wrap gap-1 mb-2.5">
                    {expert.skills.slice(0, 4).map((skill, idx) => (
                      <span key={idx} className="bg-[#F4F7FA] border border-[#E8EDF4] px-1.5 py-0.5 rounded-full text-[0.5rem] md:text-[0.55rem] font-medium text-[#4A5568]">{skill}</span>
                    ))}
                  </div>
                  <div className="flex justify-center gap-2 mt-2">
                    <Link href="#" className="w-6 h-6 rounded-md bg-[#F4F7FA] border border-[#E8EDF4] flex items-center justify-center text-[0.55rem] font-semibold text-[#4A5568] hover:bg-[#0E9BF0] hover:text-white transition-all">in</Link>
                    {expert.name === 'Sangram' && (
                      <Link href="https://sangram-bits-seo-consultant.netlify.app/" target="_blank" className="w-6 h-6 rounded-md bg-[#F4F7FA] border border-[#E8EDF4] flex items-center justify-center text-[0.55rem] font-semibold text-[#4A5568] hover:bg-[#0E9BF0] hover:text-white transition-all">🌐</Link>
                    )}
                  </div>
                </div>
              </div>
          ...
          <div className="mt-10 md:mt-12 bg-gradient-to-br from-[rgba(14,155,240,0.06)] to-[rgba(37,201,125,0.04)] border border-[rgba(14,155,240,0.12)] rounded-2xl p-6 md:p-10 lg:p-12 flex flex-col md:flex-row items-center gap-6 md:gap-8 fade-in">
            <div className="w-16 h-16 rounded-full bg-[#1C2E4A] flex items-center justify-center text-2xl flex-shrink-0">👥</div>
            <div className="text-center md:text-left">
              <h3 className="text-base md:text-lg font-bold text-[#1C2E4A] mb-1.5">Our Vetted Expert Network</h3>
              <p className="text-sm md:text-[0.85rem] font-light text-[#4A5568] leading-relaxed">
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-[#F4F7FA]">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 md:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-[#1C2E4A] rounded-2xl p-6 sm:p-8 md:p-11 text-white relative overflow-hidden fade-in">
              <div className="text-2xl md:text-3xl mb-3 md:mb-4">🎯</div>
              <h3 className="text-[1rem] md:text-[1.2rem] font-extrabold tracking-[-0.02em] mb-2 md:mb-3 text-[#F8D000]">Our Mission</h3>
              <p className="text-sm md:text-[0.88rem] font-light text-white/60 leading-relaxed">To help ambitious agencies and businesses build real recurring revenue on GoHighLevel — not through generic playbooks, but through proven systems tailored to their niche, their market, and their goals. Every deliverable we ship is benchmarked against one metric: does it grow your MRR?</p>
            </div>
            <div className="bg-gradient-to-br from-[rgba(14,155,240,0.08)] to-[rgba(37,201,125,0.05)] border border-[rgba(14,155,240,0.12)] rounded-2xl p-6 sm:p-8 md:p-11 fade-in">
              <div className="text-2xl md:text-3xl mb-3 md:mb-4">🔭</div>
              <h3 className="text-[1rem] md:text-[1.2rem] font-extrabold tracking-[-0.02em] mb-2 md:mb-3 text-[#0E9BF0]">Our Vision</h3>
              <p className="text-sm md:text-[0.88rem] font-light text-[#4A5568] leading-relaxed">To be the most trusted GoHighLevel partner in the world — the team agencies call when they are ready to stop duct-taping tools and start building a system that scales. We want every client who works with us to look back and say: "That's when things actually started working."</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-[#0B1421] text-white">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 md:px-8">
          <div className="text-center max-w-[600px] mx-auto mb-8 md:mb-12 fade-in">
            ...
            <h2 className="text-[clamp(1.4rem,3vw,2rem]] lg:text-[clamp(1.6rem,3vw,2.2rem)] font-extrabold tracking-[-0.03em] leading-[1.3] mb-3 text-white">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-5">
            <div className="bg-white/5 border border-white/10 rounded-2xl p-5 md:p-7 text-center hover:border-[rgba(248,208,0,0.25)] hover:-translate-y-1 transition-all fade-in">
              ...
              <h4 className="text-[0.8rem] md:text-[0.88rem] font-bold mb-1.5">GHL-Native First</h4>
              <p className="text-[0.65rem] md:text-[0.75rem] text-[#8A9BB0] font-light leading-relaxed">We live inside GoHighLevel. Every team member, every day. That depth is why our systems hold up at scale.</p>
            </div>
            <div className="bg-white/5 border border-white/10 rounded-2xl p-5 md:p-7 text-center hover:border-[rgba(248,208,0,0.25)] hover:-translate-y-1 transition-all fade-in">
              <div className="text-[1.5rem] md:text-[1.8rem] mb-2 md:mb-3">📈</div>
              <h4 className="text-[0.8rem] md:text-[0.88rem] font-bold mb-1.5">Revenue Over Vanity</h4>
              <p className="text-[0.65rem] md:text-[0.75rem] text-[#8A9BB0] font-light leading-relaxed">We don't measure success by tickets closed. We measure it by whether your MRR goes up.</p>
            </div>
            <div className="bg-white/5 border border-white/10 rounded-2xl p-5 md:p-7 text-center hover:border-[rgba(248,208,0,0.25)] hover:-translate-y-1 transition-all fade-in">
              <div className="text-[1.5rem] md:text-[1.8rem] mb-2 md:mb-3">🔍</div>
              <h4 className="text-[0.8rem] md:text-[0.88rem] font-bold mb-1.5">No-Fluff Communication</h4>
              <p className="text-[0.65rem] md:text-[0.75rem] text-[#8A9BB0] font-light leading-relaxed">Short sentences. Strong verbs. We say what we mean and deliver what we promise.</p>
            </div>
            <div className="bg-white/5 border border-white/10 rounded-2xl p-5 md:p-7 text-center hover:border-[rgba(248,208,0,0.25)] hover:-translate-y-1 transition-all fade-in">
              <div className="text-[1.5rem] md:text-[1.8rem] mb-2 md:mb-3">🤝</div>
              <h4 className="text-[0.8rem] md:text-[0.88rem] font-bold mb-1.5">Partner, Not Vendor</h4>
              <p className="text-[0.65rem] md:text-[0.75rem] text-[#8A9BB0] font-light leading-relaxed">We care about your business growing, not just closing the project. That's why clients stay.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 md:px-8">
          <div className="grid md:grid-cols-2 gap-10 md:gap-12 lg:gap-16 items-center">
            <div className="fade-in text-center md:text-left">
              ...
              <div className="flex flex-wrap items-center justify-center md:justify-start gap-3 text-white/40 text-xs sm:text-sm">
