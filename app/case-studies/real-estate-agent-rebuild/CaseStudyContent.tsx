// app/case-studies/real-estate-agent-rebuild/CaseStudyContent.tsx
'use client';
...
function HeroSection() {
  return (
    <header
      id="overview"
      className="bg-[#0B1628] py-12 md:py-[72px] px-4 md:px-6 relative overflow-hidden"
    ...
    >
      ...
      <div className="max-w-[760px] mx-auto relative z-10">
        <div className="flex flex-wrap gap-2 mb-4">
          <span className="bg-[rgba(14,155,240,0.15)] text-[#0E9BF0] text-[11px] font-semibold px-2.5 py-1 rounded-full">
            Case Study
          </span>
          <span className="bg-[rgba(37,201,125,0.15)] text-[#25C97D] text-[11px] font-semibold px-2.5 py-1 rounded-full">
            Real Estate
          </span>
          <span className="bg-[rgba(248,208,0,0.15)] text-[#F8D000] text-[11px] font-semibold px-2.5 py-1 rounded-full">
            GoHighLevel
          </span>
          <span className="bg-[rgba(14,155,240,0.15)] text-[#0E9BF0] text-[11px] font-semibold px-2.5 py-1 rounded-full">
            AI Voice
        ...
        <h1
          id="case-study-title"
          itemProp="headline"
          className="text-[clamp(28px,6vw,46px)] font-extrabold leading-[1.2] md:leading-[1.15] text-white mb-4 md:mb-5 tracking-[-0.02em]"
        >
          GoHighLevel for Real Estate Agents:{' '}
          <span className="text-[#F8D000]">
            A Complete Account Rebuild
          </span>
        </h1>

        {/* Author + dates (E-E-A-T signals) */}
        <div className="flex flex-wrap items-center gap-3 mb-6">
          ...
          <div>
            <div className="text-sm font-medium text-white" itemProp="author">
              GHL Scale Up Team
            </div>
            <div className="text-xs text-white/50">
              GoHighLevel Expert Agency ·{' '}
              <time dateTime="2026-08-15" itemProp="dateModified">
                Updated August 2026
              </time>
            </div>
          </div>
        ...
        <p
          className="text-base md:text-lg text-white/65 leading-relaxed mb-6 max-w-[620px]"
          itemProp="description"
        >
          A full GoHighLevel rebuild for a U.S. real estate agent{' '}
          <strong className="text-white/80">deliverability fixed</strong>, a
          niche-focused website, a rebuilt lead funnel, working calendars,
          complete CRM pipelines, and a{' '}
          <strong className="text-white/80">multi-agent AI voice</strong>{' '}
          automation system now handling thousands of real calls a month.
        </p>

        <div className="flex flex-wrap gap-3">
          <Link
            href="/contact"
            className="inline-flex items-center gap-2 bg-[#F8D000] text-[#0B1421] font-bold px-6 py-3 rounded-lg hover:bg-[#FFE44D] transition-all"
            aria-label="Get a free GoHighLevel account audit"
          >
          ...
          <Link
            href="#faq"
            className="inline-flex items-center gap-2 bg-white/10 text-white font-medium px-6 py-3 rounded-lg hover:bg-white/20 transition-all border border-white/10"
            aria-label="Skip to frequently asked questions"
          >
...
/* ============================================================
   CLIENT SUMMARY (unchanged minor aria)
   ============================================================ */
function ClientSummary() {
  ...
  return (
    <section
      ...
      className="py-12 md:py-16 bg-[#F8F9FB] border-b border-[#DDE1E9]"
    >
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            {stats.map((stat, index) => (
              <div
                key={index}
                className="bg-white p-4 md:p-6 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 border border-[#DDE1E9] hover:border-[#0E9BF0]/20 group"
              >
                <div className="w-10 h-10 md:w-12 md:h-12 bg-[#F8F9FB] rounded-lg flex items-center justify-center mb-3 md:mb-4 group-hover:bg-[#0E9BF0] transition-colors duration-300">
                  <stat.icon
                    className="w-5 h-5 md:w-6 md:h-6 text-[#0E9BF0] group-hover:text-white transition-colors duration-300"
                    aria-hidden="true"
                  />
                </div>
                <p className="text-xs md:text-sm font-medium text-[#5C6880] uppercase tracking-wider mb-1">
                  {stat.label}
                </p>
                <p className="text-base md:text-lg font-semibold text-[#1A2236]">
                  {stat.value}
                </p>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="relative bg-[#F8F9FB] border-l-4 border-[#0E9BF0] p-4 md:p-8 rounded-r-xl shadow-sm">
          <div className="absolute -top-3 -left-3 bg-[#0E9BF0] text-white rounded-full p-1.5 md:p-2">
            <Quote className="w-4 h-4 md:w-5 md:h-5" aria-hidden="true" />
          </div>
          <div className="pl-2 md:pl-4">
            <p className="text-sm md:text-lg text-[#1A2236] leading-relaxed">
              <span className="font-semibold">
                This real estate agent&apos;s GoHighLevel account looked complete but wasn&apos;t functioning:
              </span>{' '}
              ...
              <span className="font-semibold text-[#0E9BF0]">
                GHL Scale Up audited the account, rebuilt every broken system end-to-end,
                repositioned the business around a focused niche, and layered in a three-agent AI voice automation system
                now placing thousands of real calls a month.
              </span>
            </p>
          </div>
        </div>
  ...
  const challenges = [
    {
      ...
      description:
        "Outbound emails from the account were failing with a 'Forbidden' error and never reaching contacts. Every automated follow-up, confirmation, and nurture email was silently failing leads were going cold without the agent ever knowing a message hadn't sent.",
    },
    {
      icon: Phone,
      title: 'Incomplete A2P 10DLC SMS Registration',
      description:
        "A2P 10DLC is the carrier-level registration U.S. mobile networks require before a business can reliably send text messages from a 10-digit local number. This agent's registration was incomplete, which meant every SMS workflow missed-call text-back, appointment reminders, follow-up sequences was non-functional at the carrier level.",
    },
    {
      icon: BarChart3,
      title: 'An Underperforming Lead Funnel',
      description:
        'The existing lead-generation funnel was functional but not built to convert: weak design, no trust elements, and a flow that let paid or organic traffic drop off before submitting details. For a real estate lead-generation funnel, every abandoned step is ad spend or SEO effort wasted.',
    },
    {
      icon: Calendar,
      title: 'A Broken Calendar & Booking Experience',
      description:
        "The booking calendar's design and availability configuration didn't reflect a professional real estate brand, and in its broken state was showing incorrect availability meaning very few leads could actually book a call during real working hours.",
    },
    {
      icon: Database,
      title: 'A Lead Database With No System Working It',
      description:
        'Beyond the day-to-day funnel, a large existing contact database of past inquiries and dormant leads had no reactivation process at all. Every one of those contacts represented a lead the agent had already paid to acquire, sitting unworked.',
    },
  ];
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-8 md:mb-12">
            ...
            <h2
              ...
              className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#1A2236] mt-2 mb-3 md:mb-4"
            >
          ...
          <div className="space-y-4 md:space-y-6">
            {challenges.map((challenge, index) => (
              <div
                key={index}
                className="bg-white p-4 md:p-6 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 border border-[#DDE1E9] hover:border-red-200"
              >
                <div className="flex items-start gap-3 md:gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-[#1A2236] mb-1 md:mb-2 text-sm md:text-base">
                      {challenge.title}
                    </h3>
...
/* ============================================================
   REBUILD includes improved image alts
   ============================================================ */
function RebuildSection() {
  const rebuildItems = [
    ...
    },
    {
      ...
      description:
        'Both channels were broken at the infrastructure level, not just the workflow level, so the fix had to happen below the automations:',
      bullets: [
    ...
    },
    {
      ...
      description:
        "Rather than rebuild a generic real estate site, the new website repositions the agent around a specific, high-intent niche within residential real estate: new construction. Niching down is a well-established real estate marketing strategy it reduces competition with every other local agent and lets one site speak directly to a specific buyer's questions and concerns, instead of competing on a generic 'find your dream home' message.",
      hasImage: true,
      imageSrc: '/case-study/Picture1.jpeg',
      imageCaption:
        'The rebuilt website, repositioned around a new-construction buyer niche. Brand name, phone number, and identifying marketing copy have been redacted for client privacy.',
      imageAlt:
        'GoHighLevel real estate website rebuild for new construction niche case study screenshot',
      extraText:
        'The site was built mobile-responsive with tracking and lead capture wired in throughout every page, not just the homepage.',
    },
    {
      number: '4',
      title: 'Service Landing Pages & Funnels',
      description:
        'The lead-generation funnel was rebuilt from the ground up hook, offer, lead form, and thank-you confirmation designed specifically to convert real estate traffic instead of losing it mid-flow. Additional dedicated landing pages were built per service, mapped to the agent\u2019s core offers.',
    },
    {
      number: '5',
      title: 'Calendars & Booking',
      description:
        'Booking calendars were reconfigured per service with correct availability rules and buffer times, plus automated confirmation and reminder sequences so a lead can book directly into the schedule with no back-and-forth.',
    },
    {
      number: '6',
      title: 'CRM & Pipelines',
      description:
        'Pipelines and stages were built to track exactly how a lead moves from new inquiry, to booked appointment, to closed with tags and custom fields configured so every contact stays organized and reportable.',
    },
    {
      number: '7',
      title: 'Core Automations & Workflows',
      description:
        'This is where the real estate lead follow-up system actually runs 24/7. The base automation layer covers:',
      bullets: [
    ...
    },
    {
      ...
      description:
        'On top of the base automation layer, a three-agent AI voice system was built to handle the volume no solo agent could manage by phone inbound reception, outbound campaigns, and cold-lead database reactivation, each with its own script and purpose.',
      hasImage: true,
      imageSrc: '/case-study/Picture2.jpeg',
      imageCaption:
        "The live Agent List inside GoHighLevel's AI Agents module: a dedicated inbound receptionist agent, an outbound campaign agent, and a reactivation agent, each managed and versioned independently. Phone number redacted for client privacy.",
      imageAlt:
        'GoHighLevel AI Agents list inbound receptionist, outbound campaign, and reactivation agents',
      extraText:
        'The inbound agent answers calls on the agent\u2019s behalf, qualifies whether the caller is a buyer or seller, gathers contact details and intent, and either books an appointment directly or confirms a prompt follow-up built on a GPT-4.1 conversational model with a natural voice profile, background-noise cancellation, and an ambient sound setting so the call feels like a real front desk rather than a robotic IVR.',
      hasImage2: true,
      imageSrc2: '/case-study/Picture3.jpeg',
      imageCaption2:
        "The inbound voice agent's build screen model, voice, and noise-cancellation settings, plus a live web-call testing panel used before deployment. Script content (which includes business-identifying details) has been redacted.",
      imageAlt2:
        'GoHighLevel AI voice agent build screen GPT-4.1 model, voice, and noise-cancellation settings',
      extraText2:
        'A second agent handles outbound campaign calling, and a third the reactivation agent is purpose-built to work through the existing contact database, calling leads who have gone quiet and re-opening the conversation instead of leaving them to sit cold indefinitely.',
    },
    {
      number: '9',
      title: 'Email & SMS Templates',
      description:
        'Branded, reusable email and SMS templates for confirmations, reminders, follow-ups, and nurture written once, ready to use and edit from day one.',
    },
    {
      number: '10',
      title: 'Handoff & Training',
      description:
        'A clean, fully documented, modular build handed over with a walkthrough session so the system runs independently, with no ongoing dependency on GHL Scale Up unless further support is wanted.',
    },
  ];
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-6 md:space-y-8 lg:space-y-12">
            {rebuildItems.map((item, index) => (
              <div
                key={index}
                className="bg-white p-4 md:p-6 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 border border-[#DDE1E9]"
              >
                <div className="flex flex-col sm:flex-row items-start gap-4 md:gap-6">
                  ...
                  <div className="flex-1 w-full">
                    <h3 className="text-lg md:text-xl font-semibold text-[#1A2236] mb-2 md:mb-3">
                      {item.title}
                    </h3>
                    <p className="text-sm md:text-base text-[#5C6880] leading-relaxed mb-3">
                      {item.description}
                    </p>
                    ...
                    {item.bullets && (
                      <ul className="space-y-1.5 md:space-y-2 mt-2 md:mt-3">
                        {item.bullets.map((bullet, idx) => (
                          <li
                            key={idx}
                            className="flex items-start gap-2 text-sm md:text-base text-[#5C6880]"
                          >
                            <CheckCircle
                              className="w-4 h-4 text-[#0E9BF0] mt-0.5 flex-shrink-0"
                              aria-hidden="true"
                            />
                            <span>{bullet}</span>
                          </li>
                      ...
                      <figure className="mt-4">
                        <div className="relative w-full h-48 sm:h-56 md:h-64 lg:h-80 bg-[#F8F9FB] rounded-lg overflow-hidden">
                          <Image
                            ...
                            alt={item.imageAlt || item.imageCaption || 'Case study image'}
                            fill
                            className="object-cover"
                            sizes="(max-width: 640px) 100vw, (max-width: 768px) 100vw, 800px"
                          />
                        </div>
                        <figcaption className="text-xs md:text-sm text-[#5C6880] mt-2 italic">
                          {item.imageCaption}
                        </figcaption>
                        {item.extraText && (
                          <p className="text-sm md:text-base text-[#5C6880] mt-3">
                            {item.extraText}
                          </p>
                        )}
                      </figure>
                      ...
                      <figure className="mt-4">
                        <div className="relative w-full h-48 sm:h-56 md:h-64 lg:h-80 bg-[#F8F9FB] rounded-lg overflow-hidden">
                          <Image
                            ...
                            alt={item.imageAlt2 || item.imageCaption2 || 'Case study image'}
                            fill
                            className="object-cover"
                            sizes="(max-width: 640px) 100vw, (max-width: 768px) 100vw, 800px"
                          />
...
function VideoSection() {
  return (
    <section
      ...
      className="py-16 md:py-20 bg-[#F8F9FB] border-y border-[#DDE1E9]"
    >
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-6 md:mb-8">
            ...
            <h2
              id="video-heading"
              className="text-2xl md:text-3xl font-bold text-[#1A2236] mt-3"
            >
          ...
          <div className="relative w-full aspect-video bg-[#0B1628] rounded-xl overflow-hidden shadow-lg border border-[#DDE1E9]">
            <iframe
              ...
              src="https://www.youtube.com/embed/CZ-YRG3q0Nc?autoplay=0&rel=0&modestbranding=1&color=white&iv_load_policy=3"
              title="GHL Scale Up Real Estate GoHighLevel Case Study Client Testimonial"
...
function AutomationStackSection() {
  const workflows = [
    { name: 'Database Reactivation → Automated Voice AI Call → Cold Leads', status: 'Published', totalEnrolled: 1262, active: 17 },
    { name: 'Inbound Lead → Getting Appointment Booked', status: 'Published', totalEnrolled: 705, active: 437 },
    { name: 'Appointment Booked Reminders', status: 'Published', totalEnrolled: 19, active: 0 },
    { name: 'Missed Call SMS Alert → Send SMS to User', status: 'Published', totalEnrolled: 9, active: 9 },
    { name: '12-Month Dormant Drip', status: 'Published', totalEnrolled: 0, active: 0 },
    { name: '30-Day No Response Nurture', status: 'Published', totalEnrolled: 0, active: 0 },
    { name: 'GMB Reviews', status: 'Draft', totalEnrolled: 0, active: 0 },
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-8 md:mb-12">
            ...
            <figure className="max-w-3xl mx-auto mb-6 md:mb-8">
              <div className="relative w-full h-48 sm:h-56 md:h-64 lg:h-80 bg-[#F8F9FB] rounded-lg overflow-hidden">
                <Image
                  src="/case-study/Picture4.jpeg"
                  alt="GoHighLevel automations list showing publish status and enrollment counts for the real estate account"
                  fill
                  className="object-cover"
                  sizes="(max-width: 640px) 100vw, (max-width: 768px) 100vw, 800px"
                />
              </div>
              <figcaption className="text-xs md:text-sm text-[#5C6880] mt-2 italic text-center">
            ...
            <div className="overflow-x-auto">
              <table className="min-w-[600px] md:min-w-full divide-y divide-[#DDE1E9]">
                <caption className="sr-only">
                  GoHighLevel workflows, publish status, enrollment counts, and active contacts
                </caption>
                <thead className="bg-[#F8F9FB]">
                  <tr>
                    <th scope="col" className="px-4 md:px-6 py-3 md:py-4 text-left text-xs md:text-sm font-semibold text-[#1A2236]">Workflow</th>
                    <th scope="col" className="px-4 md:px-6 py-3 md:py-4 text-left text-xs md:text-sm font-semibold text-[#1A2236]">Status</th>
                    <th scope="col" className="px-4 md:px-6 py-3 md:py-4 text-right text-xs md:text-sm font-semibold text-[#1A2236]">Total Enrolled</th>
                    <th scope="col" className="px-4 md:px-6 py-3 md:py-4 text-right text-xs md:text-sm font-semibold text-[#1A2236]">Active</th>
                  </tr>
                </thead>
                    ...
                    <tr key={index} className={index % 2 === 0 ? 'bg-white' : 'bg-[#F8F9FB]/50'}>
                      ...
                      <td className="px-4 md:px-6 py-3 md:py-4 text-xs md:text-sm">
                        <span className={`inline-flex items-center px-2 md:px-3 py-0.5 md:py-1 rounded-full text-xs font-semibold ${
                          workflow.status === 'Published' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'
                        }`}>
                          {workflow.status}
                        </span>
                      </td>
                      ...
                      <td className="px-4 md:px-6 py-3 md:py-4 text-xs md:text-sm text-[#1A2236] text-right">
                        <span className={`font-semibold ${workflow.active > 0 ? 'text-[#0E9BF0]' : 'text-[#5C6880]'}`}>
                          {workflow.active}
                        </span>
                      </td>
                    </tr>
          ...
          <div className="mt-6 bg-white border border-[#0E9BF0]/20 rounded-xl p-4 md:p-6 shadow-sm">
            <div className="flex flex-col sm:flex-row items-start gap-3 md:gap-4">
              <div className="flex-shrink-0 w-10 h-10 md:w-12 md:h-12 bg-[#0E9BF0] text-white rounded-xl flex items-center justify-center">
                <Database className="w-5 h-5 md:w-6 md:h-6" aria-hidden="true" />
              </div>
              <div>
                <h3 className="font-semibold text-[#1A2236] mb-1 text-base md:text-lg">
                  Database Reactivation Highlight
                </h3>
                <p className="text-sm md:text-base text-[#5C6880]">
                  The headline number here is the database reactivation workflow:{' '}
                  <strong className="font-bold text-[#0E9BF0] text-lg md:text-xl">1,262</strong>{' '}
                  previously cold contacts have been enrolled into an automated sequence that places a voice AI call,
                  listens for a response, and branches the conversation based on what the lead says a workload that
                  would take a solo agent weeks to work manually by phone.
                </p>
              </div>
            </div>
          </div>
...
function InsideReactivationWorkflow() {
  return (
    <section
      id="reactivation-workflow"
      aria-labelledby="reactivation-heading"
      className="py-16 md:py-20"
    >
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          <h2
            id="reactivation-heading"
            className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#1A2236] text-center mb-4 md:mb-6"
          >
          ...
          <p className="text-sm md:text-base text-[#5C6880] text-center max-w-3xl mx-auto mb-6 md:mb-8 leading-relaxed">
            The database reactivation workflow follows a branching call-and-wait structure: it places the AI voice call,
            checks whether the contact responds or confirms interest, and branches down different paths depending on the
            outcome re-attempting later, tagging the lead as interested, or handing off for human follow-up
            repeating the cycle across multiple wait/retry stages rather than a single one-shot call.
          </p>
          ...
          <figure className="max-w-3xl mx-auto">
            <div className="relative w-full h-64 sm:h-72 md:h-80 lg:h-96 bg-[#F8F9FB] rounded-lg overflow-hidden">
              <Image
                ...
                alt="GoHighLevel database reactivation workflow AI voice call steps with conditional checks and timed retries"
                fill
                className="object-cover"
                sizes="(max-width: 640px) 100vw, (max-width: 768px) 100vw, 800px"
              />
          ...
          <figure className="max-w-3xl mx-auto mb-6 md:mb-8">
            <div className="relative w-full h-48 sm:h-56 md:h-64 lg:h-80 bg-[#F8F9FB] rounded-lg overflow-hidden">
              <Image
                ...
                alt="GoHighLevel AI voice agent outbound call performance: 7,105 attempted calls, 5,471 connected, 97% positive sentiment over 17 days"
                fill
                className="object-cover"
                sizes="(max-width: 640px) 100vw, (max-width: 768px) 100vw, 800px"
              />
          ...
          <div className="bg-white rounded-xl shadow-sm overflow-hidden border border-[#DDE1E9] mb-6 md:mb-8">
            <div className="overflow-x-auto">
              <table className="min-w-[500px] md:min-w-full divide-y divide-[#DDE1E9]">
                <caption className="sr-only">
                  AI voice agent performance metrics from the live GoHighLevel dashboard
                </caption>
                <thead className="bg-[#F8F9FB]">
                  <tr>
                    <th scope="col" className="px-4 md:px-6 py-3 md:py-4 text-left text-xs md:text-sm font-semibold text-[#1A2236]">Metric</th>
                    <th scope="col" className="px-4 md:px-6 py-3 md:py-4 text-left text-xs md:text-sm font-semibold text-[#1A2236]">Value</th>
                    <th scope="col" className="px-4 md:px-6 py-3 md:py-4 text-left text-xs md:text-sm font-semibold text-[#1A2236]">What it means</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-[#DDE1E9]">
...
function ClutchReviewsSection() {
  const reviews = [
    { id: 1, imageSrc: '/case-study/clutch-review-1.png', alt: 'Clutch review 5 star rating for GHL Scale Up GoHighLevel services' },
    { id: 2, imageSrc: '/case-study/clutch-review-2.png', alt: 'Clutch review client testimonial for GoHighLevel real estate automation services' },
    { id: 3, imageSrc: '/case-study/clutch-review-3.png', alt: 'Clutch review verified review for GHL Scale Up GoHighLevel account rebuild' },
  ];
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-8 md:mb-12">
            <div className="flex items-center justify-center gap-2 mb-3">
              <Award className="w-6 h-6 text-[#0E9BF0]" aria-hidden="true" />
            ...
            {reviews.map((review) => (
              ...
              >
                ...
                <div className="p-3 md:p-4 text-center">
                  <div className="flex items-center justify-center gap-1 mb-1" aria-label="5 out of 5 stars">
                    {[...Array(5)].map((_, i) => (
                      <svg key={i} className="w-4 h-4 text-[#F8D000] fill-[#F8D000]" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-3 md:space-y-4">
            {points.map((point, index) => (
              <div
                key={index}
                className="group bg-white p-4 md:p-6 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 border-l-4 border-[#0E9BF0]"
              >
                <div className="flex items-start gap-3 md:gap-4">
                  <div className="flex-shrink-0 w-6 h-6 md:w-8 md:h-8 bg-[#F8F9FB] rounded-full flex items-center justify-center group-hover:bg-[#0E9BF0] transition-colors duration-300">
                    <span className="text-[#0E9BF0] group-hover:text-white font-bold text-xs md:text-sm">
                      •
                    </span>
                  </div>
                  <p className="text-sm md:text-base text-[#5C6880] leading-relaxed">
...
/* ============================================================
   RELATED CASE STUDIES Internal linking for SEO
   ============================================================ */
function RelatedCaseStudies() {
  const related = [
    {
      title: 'GoHighLevel for Agencies: Multi-Account Rebuild',
      href: '/case-studies/agency-multi-account-rebuild',
      tag: 'Agency',
    },
    {
      title: 'AI Voice Agents for Home Services: Booking Automation',
      href: '/case-studies/home-services-ai-voice',
      tag: 'Home Services',
    },
    {
      title: 'GoHighLevel Deliverability & A2P 10DLC Fix',
      href: '/case-studies/deliverability-a2p-fix',
      tag: 'Deliverability',
    },
  ];
    ...
    >
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          <h2
            id="related-heading"
            className="text-2xl md:text-3xl font-bold text-[#1A2236] text-center mb-6 md:mb-10"
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
            {related.map((item, i) => (
              <Link
                key={i}
                href={item.href}
                className="group bg-white p-5 rounded-xl border border-[#DDE1E9] hover:border-[#0E9BF0]/40 hover:shadow-lg transition-all"
              >
                <span className="inline-block bg-[#0E9BF0]/10 text-[#0E9BF0] text-[10px] font-semibold px-2 py-1 rounded-full mb-3">
                  {item.tag}
                </span>
                <h3 className="text-base md:text-lg font-semibold text-[#1A2236] group-hover:text-[#0E9BF0] transition-colors mb-2">
                  {item.title}
                </h3>
                <span className="inline-flex items-center gap-1 text-sm text-[#0E9BF0] font-medium">
                  Read case study
  ...
  const faqs = [
    {
      ...
      answer:
        "Emails typically fail when the sending domain lacks proper SPF, DKIM, and DMARC authentication, or when the domain's reputation triggers a rejection from the receiving server. A 'Forbidden' error usually means the domain isn't correctly authenticated to send on the platform's behalf, and needs to be reconfigured and re-verified.",
    },
    {
      question: 'What is A2P 10DLC and why does a real estate agent need it?',
      answer:
        'A2P 10DLC (Application-to-Person 10-Digit Long Code) is the U.S. carrier registration system that verifies a business before allowing it to send text messages from a standard local number. Real estate agents sending SMS follow-ups, appointment reminders, or missed-call text-backs to U.S. leads need a completed registration, or carriers will filter or block the messages entirely.',
    },
    {
      question: 'What is an AI voice agent for real estate?',
      answer:
        "An AI voice agent is software that answers or places phone calls using a conversational AI model and a natural-sounding voice, following a structured script to qualify leads, answer common questions, and book appointments functioning as a 24/7 front desk or outbound caller for an agent's business.",
    },
    {
      question: 'How does AI lead reactivation work for a real estate database?',
      answer:
        "A reactivation workflow automatically calls contacts who have gone cold typically leads that haven't responded in months using an AI voice agent to reopen the conversation, gauge interest, and either book a follow-up or route the contact back into a nurture sequence, all without manual dialing.",
    },
    {
      question: 'Is it legal to use AI for outbound real estate calls?',
      answer:
        'Outbound AI and automated calling in the U.S. is subject to consent and do-not-call rules that vary by call type and jurisdiction. Agents should confirm their own compliance requirements (including consent practices for contacts being called) with a qualified professional before scaling outbound AI calling this is general information, not legal advice.',
    },
    {
      question: 'What automations should a real estate agent set up first in GoHighLevel?',
      answer:
        'Instant lead response and missed-call text-back deliver the fastest return, since real estate inquiries are highly time-sensitive. Appointment reminder and no-show follow-up sequences, a review-request automation, and once volume justifies it an AI voice agent for inbound qualification or database reactivation typically follow next.',
    },
    {
      question: 'How much does a GoHighLevel setup cost for a real estate agent?',
      answer:
        'Setup costs vary by scope. A full end-to-end rebuild deliverability fixes, website, funnels, calendars, CRM, automations, and AI voice agents is typically a one-time project investment, often paired with an optional ongoing monthly maintenance plan.',
    },
  ];
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-3 md:space-y-4">
            {faqs.map((faq, index) => (
              <div
                key={index}
                className="bg-white border border-[#DDE1E9] rounded-xl overflow-hidden hover:shadow-md transition-shadow duration-300"
              >
                <details className="group">
                  <summary className="flex items-center justify-between w-full px-4 md:px-6 py-4 md:py-5 text-left cursor-pointer hover:bg-[#F8F9FB] transition-colors duration-200">
                    <h3 className="text-sm md:text-base font-semibold text-[#1A2236] pr-4">
                      {faq.question}
                    </h3>
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden" aria-hidden="true">
        <div className="absolute -top-40 -right-40 w-64 md:w-96 h-64 md:h-96 bg-[#0E9BF0]/20 rounded-full mix-blend-multiply filter blur-3xl opacity-10" />
        <div className="absolute -bottom-40 -left-40 w-64 md:w-96 h-64 md:h-96 bg-[#0E9BF0]/20 rounded-full mix-blend-multiply filter blur-3xl opacity-10" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] md:w-[600px] h-[400px] md:h-[600px] bg-[#0E9BF0]/10 rounded-full filter blur-3xl opacity-5" />
      </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mt-6 md:mt-8 flex flex-wrap items-center justify-center gap-4 md:gap-6 text-white/50 text-xs md:text-sm">
            <div className="flex items-center gap-1.5 md:gap-2">
              <CheckCircle className="w-3 h-3 md:w-4 md:h-4 text-[#0E9BF0]" aria-hidden="true" />
