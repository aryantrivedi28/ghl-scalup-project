// app/case-studies/gohighlevel-affiliate-management-automation-media-company/CaseStudyContent.tsx
'use client';
      ...
      <div className="max-w-[760px] mx-auto relative z-10">
        ...
        >
          ...
          <span className="text-[#F8D000]">
            How GHL Scale Up Automated Affiliate Tracking and Lead Nurturing for a Media Company
          </span>
        </h1>
        ...
        <div className="bg-white/5 border border-white/10 rounded-xl p-4 md:p-5 mb-6 overflow-x-auto">
          ...
          <table className="w-full text-sm border-collapse">
            <caption className="sr-only">
              Before and after comparison of the GoHighLevel affiliate management system built for Crump Media LLC
            </caption>
            <thead>
        ...
        <div className="flex flex-wrap gap-3">
          <Link
            ...
            aria-label="Get a free GoHighLevel affiliate management consultation"
          >
          ...
          <div className="pl-2 md:pl-4">
            <p className="text-sm md:text-lg text-[#1A2236] leading-relaxed">
              <span className="font-semibold">
                A media and performance-driven business was running multiple affiliate campaigns simultaneously, but managing them manually created operational bottlenecks.
              </span>{' '}
              ...
              <span className="font-semibold text-[#0E9BF0]">
                {' '}
                GHL Scale Up designed and implemented a custom GoHighLevel affiliate management system with structured email and SMS drip campaigns, automated reporting dashboards, and centralized affiliate tracking improving lead engagement and increasing conversion rates.
              </span>
            </p>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-6 md:mb-8">
            ...
            <p className="text-sm md:text-base text-[#5C6880] mt-2 max-w-2xl mx-auto">
              See how we transformed this media company&apos;s affiliate operations with automated tracking, lead nurturing, and real-time reporting dashboards.
            </p>
          </div>
          ...
          <div className="relative w-full aspect-video bg-[#0B1628] rounded-xl overflow-hidden shadow-lg border border-[#DDE1E9]">
            <iframe
              ...
              title="GHL Scale Up Client Testimonial Crump Media LLC Affiliate Management Case Study"
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-white p-4 md:p-6 rounded-xl shadow-sm border border-[#DDE1E9]">
            ...
            <h3 className="font-semibold text-[#1A2236] text-base mb-3">
              The Initial Challenge: Manual Affiliate Campaign Management Couldn&apos;t Scale
            </h3>
            <p className="text-sm md:text-base text-[#5C6880] leading-relaxed mb-4">
            ...
            <div className="space-y-3">
              <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                <div className="flex items-start gap-3">
                  <div className="flex-shrink-0 w-8 h-8 bg-red-100 rounded-lg flex items-center justify-center">
                    <MessageSquare className="w-4 h-4 text-red-600" aria-hidden="true" />
                  </div>
                  <div>
                    ...
                    <p className="text-sm text-[#5C6880]">
                      since nurturing wasn&apos;t running on structured, automated sequences.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-[#1A2236] text-sm">
                      Unclear affiliate performance tracking
                    </h4>
                    <p className="text-sm text-[#5C6880]">
                      making it difficult to see which affiliates and campaigns were actually driving results.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#5C6880]">
                      pulling time away from campaign execution and strategy.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="mt-6 bg-white p-4 md:p-6 rounded-xl shadow-sm border border-[#DDE1E9]">
            ...
            <ul className="space-y-2 text-sm text-[#5C6880]">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong className="text-[#1A2236]">Affiliate tracking and lead nurturing are two different systems that need to work together.</strong> Affiliate performance data (clicks, conversions, commissions) and lead nurturing workflows (follow-up emails, SMS sequences) are often managed separately, which makes it hard to connect affiliate activity to actual lead outcomes.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-[#0E9BF0] flex-shrink-0 mt-0.5" aria-hidden="true" />
                <span>
                  <strong className="text-[#1A2236]">Manual reporting doesn&apos;t scale with campaign volume.</strong> As the number of active affiliate campaigns grows, manually compiling performance data becomes a full-time task on its own rather than a byproduct of the system.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-[#0E9BF0] flex-shrink-0 mt-0.5" aria-hidden="true" />
                <span>
                  <strong className="text-[#1A2236]">Inconsistent nurturing undermines affiliate results.</strong> An affiliate can drive a strong lead, but if that lead isn&apos;t followed up with consistently afterward, the value of the referral is lost meaning nurturing automation directly affects affiliate program performance.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-[#0E9BF0] flex-shrink-0 mt-0.5" aria-hidden="true" />
                <span>
                  <strong className="text-[#1A2236]">No centralized visibility makes optimization guesswork.</strong> Without real-time dashboards, it&apos;s difficult to identify which campaigns or affiliates are underperforming until well after the fact.
                </span>
              </li>
            </ul>
          </div>
...
function DripCampaignsSection() {
  return (
    <section
      id="drip-campaigns"
      aria-labelledby="drip-campaigns-heading"
      className="py-16 md:py-20"
    >
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 gap-4 mt-4">
              <div className="bg-[#F8F9FB] rounded-lg p-4 border border-[#DDE1E9]">
                <div className="flex items-center gap-2 mb-2">
                  <Mail className="w-4 h-4 text-[#0E9BF0]" aria-hidden="true" />
              ...
              <div className="bg-[#F8F9FB] rounded-lg p-4 border border-[#DDE1E9]">
                <div className="flex items-center gap-2 mb-2">
                  <MessageSquare className="w-4 h-4 text-[#0E9BF0]" aria-hidden="true" />
...
function AffiliateSystemSection() {
  return (
    <section
      id="affiliate-system"
      aria-labelledby="affiliate-system-heading"
      className="py-16 md:py-20 bg-[#F8F9FB]"
    >
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
...
function ReportingDashboardsSection() {
  return (
    <section
      ...
      aria-labelledby="reporting-dashboards-heading"
      className="py-16 md:py-20"
    >
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-8 md:mb-12">
            ...
            <h2
              id="reporting-dashboards-heading"
              className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#1A2236] mt-2 mb-3 md:mb-4"
            >
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="overflow-x-auto">
            <table className="w-full border-collapse text-sm">
              <caption className="sr-only">
                Six-stage GoHighLevel affiliate management implementation process for Crump Media LLC
              </caption>
              <thead>
  ...
  const faqs = [
    {
      ...
      answer:
        'An affiliate management system inside GoHighLevel is typically built around campaign-based tracking, where each affiliate program or offer is set up with its own commission structure, tracking links, and automated onboarding workflow, then connected to the same lead and communication tools used for the rest of the business.',
    },
    {
      question: 'Can GoHighLevel track affiliate commissions and conversions?',
      answer:
        "Yes. GoHighLevel's Affiliate Manager supports tracking clicks, conversions, and commissions per campaign, with options for flat, percentage, recurring, or tiered commission structures depending on how the program is configured.",
    },
    {
      question: 'Can affiliates have their own login to track their performance in GoHighLevel?',
      answer:
        'Yes. GoHighLevel supports a self-service affiliate portal where partners can log in to view their own earnings, tracking links, and performance stats without needing access to the main account.',
    },
    {
      question: 'How does GoHighLevel automate lead nurturing for affiliate-driven leads?',
      answer:
        'Leads generated through affiliate campaigns can be routed into structured email and SMS drip sequences automatically, ensuring consistent follow-up regardless of which affiliate or campaign the lead originated from.',
    },
    {
      question: 'Why is manual affiliate campaign management difficult to scale?',
      answer:
        'As the number of active affiliate campaigns grows, manually tracking performance, following up with leads, and compiling reports becomes increasingly time-consuming, which is why centralizing these processes inside an automated system becomes necessary once a business is running multiple campaigns at once.',
    },
    {
      question: 'What is the difference between running affiliate tracking manually versus inside GoHighLevel?',
      answer:
        'Manual affiliate tracking typically relies on spreadsheets or separate tools disconnected from lead communication, making it hard to see how affiliate activity connects to actual conversions. Building affiliate tracking inside GoHighLevel keeps affiliate data, lead nurturing, and reporting in one connected system.',
    },
    {
      question: 'Can GoHighLevel generate real-time reporting dashboards for affiliate and campaign performance?',
      answer:
        'Yes. Custom dashboards can be built inside GoHighLevel to show live affiliate and campaign performance data, removing the need to manually compile reports from multiple sources.',
    },
    {
      question: 'How do structured email and SMS drip campaigns improve conversion rates for affiliate-driven leads?',
      answer:
        'Drip campaigns keep leads engaged with consistent, timed follow-up messaging after the initial referral, which increases the likelihood that an affiliate-driven lead converts instead of going cold from a lack of follow-up.',
    },
    {
      question: 'Is a custom-built affiliate system better than a generic affiliate plugin or third-party tool?',
      answer:
        "A custom affiliate management system built inside GoHighLevel can be tailored to a business's specific campaign structure and integrated directly with existing lead and communication workflows, which reduces the data gaps that come from running affiliate tracking on a separate, disconnected platform.",
    },
  ];
