// app/case-studies/gohighlevel-multi-location-automation-property-website-real-estate/CaseStudyContent.tsx
'use client';
      ...
      <div className="max-w-[760px] mx-auto relative z-10">
        ...
        >
          ...
          <span className="text-[#F8D000]">
            How GHL Scale Up Built a Scalable Sub-Account System With Property Websites
          </span>
        </h1>
        ...
        <div className="bg-white/5 border border-white/10 rounded-xl p-4 md:p-5 mb-6 overflow-x-auto">
          <h2 className="text-xs font-bold text-[#F8D000] uppercase tracking-wider mb-3">
            Quick Results Summary
          </h2>
          <table className="w-full text-sm border-collapse">
            <caption className="sr-only">
              Before and after comparison of the multi-location GoHighLevel build for BLLR
            </caption>
            <thead>
              <tr className="border-b border-white/10">
                <th scope="col" className="text-left py-2 px-2 text-white/60 font-medium text-xs">Area</th>
                <th scope="col" className="text-left py-2 px-2 text-white/60 font-medium text-xs">Before</th>
                <th scope="col" className="text-left py-2 px-2 text-white/60 font-medium text-xs">After GHL Scale Up</th>
              </tr>
            </thead>
        ...
        <div className="flex flex-wrap gap-3">
          <Link
            ...
            aria-label="Get a free multi-location GoHighLevel real estate consultation"
          >
          ...
          <div className="pl-2 md:pl-4">
            <p className="text-sm md:text-lg text-[#1A2236] leading-relaxed">
              <span className="font-semibold">
                A growing real estate brand was managing property listings and client inquiries manually across different locations.
              </span>{' '}
              ...
              <span className="font-semibold text-[#0E9BF0]">
                {' '}
                GHL Scale Up implemented a multi-subaccount GoHighLevel architecture with location-based property websites and automated buyer/seller workflows enabling faster response times, consistent client experience, and simplified multi-location management.
              </span>
            </p>
          </div>
        </div>
...
/* ==================== VIDEO SECTION (commented out preserved) ==================== */
function VideoSection() {
  return (
    <section
      id="testimonial"
      aria-labelledby="video-heading"
      className="py-16 md:py-20 bg-[#F8F9FB] border-t border-[#DDE1E9] border-b border-[#DDE1E9]"
    >
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-6 md:mb-8">
            ...
            <p className="text-sm md:text-base text-[#5C6880] mt-2 max-w-2xl mx-auto">
              See how we transformed this multi-location real estate brand&apos;s operations with sub-account architecture and location-based property websites.
            </p>
          </div>
          ...
          <div className="relative w-full aspect-video bg-[#0B1628] rounded-xl overflow-hidden shadow-lg border border-[#DDE1E9]">
            <iframe
              ...
              src="https://www.youtube.com/embed/YgSBBP37b0M?autoplay=0&rel=0&modestbranding=1&color=white&iv_load_policy=3"
              title="GHL Scale Up Client Testimonial BLLR Multi-Location Real Estate Case Study"
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-white p-4 md:p-6 rounded-xl shadow-sm border border-[#DDE1E9]">
            <h3 className="font-semibold text-[#1A2236] text-base mb-3">
              About the Client
            </h3>
            ...
            <h3 className="font-semibold text-[#1A2236] text-base mb-3">
              The Initial Challenge: Manual, Fragmented Multi-Location Operations
            </h3>
            <p className="text-sm md:text-base text-[#5C6880] leading-relaxed mb-4">
            ...
            <div className="space-y-3">
              <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-[#1A2236] text-sm">
                      Delayed responses
                    </h4>
                    <p className="text-sm text-[#5C6880]">
                      since inquiries in each location were being handled manually rather than routed and followed up automatically.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                <div className="flex items-start gap-3">
                  <div className="flex-shrink-0 w-8 h-8 bg-red-100 rounded-lg flex items-center justify-center">
                    <BarChart3 className="w-4 h-4 text-red-600" aria-hidden="true" />
                  </div>
                  <div>
                    <h4 className="font-semibold text-[#1A2236] text-sm">
                    ...
                    <p className="text-sm text-[#5C6880]">
                      with no centralized way to see how leads were moving across every location at once.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                <div className="flex items-start gap-3">
                  <div className="flex-shrink-0 w-8 h-8 bg-red-100 rounded-lg flex items-center justify-center">
                    <Settings2 className="w-4 h-4 text-red-600" aria-hidden="true" />
                  </div>
                  <div>
                    <h4 className="font-semibold text-[#1A2236] text-sm">
                    ...
                    <p className="text-sm text-[#5C6880]">
                      as handling multiple regions without a centralized system made it difficult to maintain consistency, track performance, or scale operations efficiently.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="mt-6 bg-white p-4 md:p-6 rounded-xl shadow-sm border border-[#DDE1E9]">
            <h3 className="font-semibold text-[#1A2236] text-base mb-3">
              Why Multi-Location Real Estate Businesses Struggle With a Single GoHighLevel Account
            </h3>
            <p className="text-sm md:text-base text-[#5C6880] leading-relaxed mb-4">
            ...
            <ul className="space-y-2 text-sm text-[#5C6880]">
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-[#0E9BF0] flex-shrink-0 mt-0.5" aria-hidden="true" />
                <span>
                  <strong className="text-[#1A2236]">One account, multiple markets.</strong> A single GoHighLevel account without sub-accounts forces all locations to share pipelines, workflows, and contact data, making it hard to isolate performance or tailor follow-up by region.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-[#0E9BF0] flex-shrink-0 mt-0.5" aria-hidden="true" />
                <span>
                  <strong className="text-[#1A2236]">No region-specific web presence.</strong> A single generic website can&apos;t effectively showcase location-specific property listings, which hurts both lead relevance and local SEO.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-[#0E9BF0] flex-shrink-0 mt-0.5" aria-hidden="true" />
                <span>
                  <strong className="text-[#1A2236]">Buyer and seller workflows aren&apos;t the same.</strong> Real estate inquiries split into fundamentally different journeys buyers need property matching and viewing follow-up, sellers need listing and valuation follow-up and a single generic workflow can&apos;t serve both well.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-[#0E9BF0] flex-shrink-0 mt-0.5" aria-hidden="true" />
                <span>
                  <strong className="text-[#1A2236]">No cross-location visibility.</strong> Without centralized reporting, leadership can&apos;t see which locations are converting well and which need support, making it difficult to make informed, timely decisions.
                </span>
              </li>
            </ul>
          </div>
...
function SubAccountArchitectureSection() {
  return (
    <section
      id="sub-account-architecture"
      aria-labelledby="sub-account-heading"
      className="py-16 md:py-20 bg-[#F8F9FB]"
    >
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
            ...
            <div className="grid sm:grid-cols-3 gap-4 mt-4">
              <div className="bg-[#F8F9FB] rounded-lg p-4 border border-[#DDE1E9] text-center">
                <div className="w-10 h-10 rounded-full bg-[#F8F9FB] flex items-center justify-center mx-auto mb-2">
                  <GitBranch className="w-5 h-5 text-[#0E9BF0]" aria-hidden="true" />
                </div>
                <h3 className="font-semibold text-[#1A2236] text-sm">Independent Pipelines</h3>
                <p className="text-xs text-[#5C6880]">Each location runs its own pipelines and workflows</p>
              </div>
              <div className="bg-[#F8F9FB] rounded-lg p-4 border border-[#DDE1E9] text-center">
                <div className="w-10 h-10 rounded-full bg-[#F8F9FB] flex items-center justify-center mx-auto mb-2">
                  <Users className="w-5 h-5 text-[#0E9BF0]" aria-hidden="true" />
                </div>
                <h3 className="font-semibold text-[#1A2236] text-sm">Contact Records</h3>
                <p className="text-xs text-[#5C6880]">Separate contact records per location</p>
              </div>
              <div className="bg-[#F8F9FB] rounded-lg p-4 border border-[#DDE1E9] text-center">
                <div className="w-10 h-10 rounded-full bg-[#F8F9FB] flex items-center justify-center mx-auto mb-2">
                  <Globe className="w-5 h-5 text-[#0E9BF0]" aria-hidden="true" />
                </div>
                <h3 className="font-semibold text-[#1A2236] text-sm">Centralized Brand</h3>
...
function PropertyWebsitesSection() {
  return (
    <section
      ...
      aria-labelledby="property-websites-heading"
      className="py-16 md:py-20"
    >
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
...
function AutomatedWorkflowsSection() {
  return (
    <section
      ...
      aria-labelledby="automated-workflows-heading"
      className="py-16 md:py-20 bg-[#F8F9FB]"
    >
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-8 md:mb-12">
            ...
            <h2
              id="automated-workflows-heading"
              className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#1A2236] mt-2 mb-3 md:mb-4"
            >
            ...
            <div className="grid sm:grid-cols-2 gap-4 mt-4">
              <div className="bg-[#F8F9FB] rounded-lg p-4 border border-[#DDE1E9]">
                <div className="flex items-center gap-2 mb-2">
                  <Users className="w-4 h-4 text-[#0E9BF0]" aria-hidden="true" />
              ...
              <div className="bg-[#F8F9FB] rounded-lg p-4 border border-[#DDE1E9]">
                <div className="flex items-center gap-2 mb-2">
                  <Home className="w-4 h-4 text-[#0E9BF0]" aria-hidden="true" />
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="overflow-x-auto">
            <table className="w-full border-collapse text-sm">
              <caption className="sr-only">
                Six-stage multi-location GoHighLevel implementation process for BLLR
              </caption>
              <thead>
                <tr className="bg-[#F8F9FB] border-b border-[#DDE1E9]">
                  <th scope="col" className="text-left py-3 px-4 font-semibold text-[#1A2236]">Stage</th>
                  <th scope="col" className="text-left py-3 px-4 font-semibold text-[#1A2236]">What GHL Scale Up Did</th>
                </tr>
              </thead>
              <tbody>
                {stages.map((stage, index) => (
                  <tr
                    key={index}
                    className="border-b border-[#DDE1E9] hover:bg-[#F8F9FB]/50 transition-colors"
                  >
                    <td className="py-3 px-4 font-medium text-[#1A2236]">
                      {stage.title}
                    </td>
                    <td className="py-3 px-4 text-[#5C6880]">
                      {stage.description}
                    </td>
                  </tr>
                ))}
          ...
          <div className="bg-white rounded-xl shadow-sm border border-[#DDE1E9] p-4 md:p-6">
            <ul className="space-y-3">
              {results.map((result, index) => (
                <li
                  key={index}
                  className="flex items-start gap-3 text-sm md:text-base text-[#5C6880]"
                >
                  <CheckCircle
                    className="w-5 h-5 text-[#25C97D] flex-shrink-0 mt-0.5"
                    aria-hidden="true"
                  />
                  <span>{result}</span>
                </li>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-3 md:space-y-4">
            {takeaways.map((takeaway, index) => (
              <div
                key={index}
                className="group bg-white p-4 md:p-6 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 border-l-4 border-[#0E9BF0] hover:border-[#0E9BF0]"
              >
...
function RelatedCaseStudies() {
  const related = [
    {
      title: 'Real Estate GoHighLevel Rebuild + AI Voice Agents',
      href: '/case-studies/real-estate-agent-rebuild',
      tag: 'Real Estate',
    },
    {
      title: 'RiverEnergia GoHighLevel Parent SaaS & Multi-Brand CRM',
      href: '/case-studies/gohighlevel-parent-saas-multi-crm-automation-energy-platform',
      tag: 'Parent SaaS',
    },
    {
      title: 'GoHighLevel AI Automation for Marketing Agencies Capviax',
  ...
  const faqs = [
    {
      ...
      answer:
        'GoHighLevel supports multi-location businesses through sub-accounts, where each location gets its own independent CRM, pipelines, and workflows while still rolling up under a centralized agency or brand account for oversight and reporting.',
    },
    {
      question: 'Should each real estate office have its own GoHighLevel sub-account?',
      answer:
        'Yes, in most cases. A separate sub-account per location keeps leads, pipelines, and workflows specific to that market, which avoids mixing contact data and makes it easier to track performance location by location.',
    },
    {
      question: 'How do you build a property website for real estate inside GoHighLevel?',
      answer:
        "A property website inside GoHighLevel is built using GoHighLevel's website and funnel builder, connected to location-specific listing data and lead capture forms so that inquiries flow directly into the correct sub-account's pipeline.",
    },
    {
      question: 'Can GoHighLevel automate follow-up for both real estate buyers and sellers?',
      answer:
        'Yes. GoHighLevel workflows can be built separately for buyer leads (property matching, viewing follow-up) and seller leads (listing inquiries, valuation follow-up), since these require different messaging and different next steps.',
    },
    {
      question: 'How do multi-location businesses track leads across all locations in one place?',
      answer:
        "By building internal reporting and lead management on top of each location's GoHighLevel sub-account data, giving leadership a consolidated view of lead volume, response times, and conversion across every location without logging into each sub-account separately.",
    },
    {
      question: 'What is the difference between a GoHighLevel sub-account and a single shared account for multiple locations?',
      answer:
        "A single shared account mixes all locations' contacts, pipelines, and workflows together, making it hard to isolate performance or customize follow-up by region. Separate sub-accounts keep each location's data and automation independent while still allowing centralized oversight.",
    },
    {
      question: 'Why is a generic real estate website not enough for a multi-location brand?',
      answer:
        "A single generic website can't effectively showcase location-specific property listings or rank well for local searches in each market. Dynamic, location-based websites let each region highlight its own inventory and improve local search relevance.",
    },
    {
      question: 'How long does it take to set up a multi-location GoHighLevel system for real estate?',
      answer:
        "Timelines depend on how many locations are involved and how much existing data needs to be structured, but the process generally starts with mapping each location's process, followed by building sub-accounts, workflows, and location-specific websites.",
    },
    {
      question: 'Can GoHighLevel scale with a real estate brand as it expands into new regions?',
      answer:
        'Yes, when the account is built on a sub-account architecture from the start. New locations can be added as new sub-accounts using a repeatable setup, rather than requiring a rebuild of the existing system each time the brand expands.',
    },
  ];
