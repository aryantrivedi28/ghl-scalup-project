// app/case-studies/gohighlevel-parent-saas-multi-crm-automation-energy-platform/CaseStudyContent.tsx
'use client';
  ...
  return (
    ...
    >
      ...
      <div className="max-w-[760px] mx-auto relative z-10">
        ...
        >
          Unified multiple business verticals under one GoHighLevel SaaS
          structure, with AI-driven automation cutting lead response time to
          under a minute.
        </p>
        ...
        <div className="flex flex-wrap gap-3">
          <Link
            ...
            aria-label="Get a free GoHighLevel parent SaaS consultation"
          >
          ...
          <div className="pl-2 md:pl-4">
            <p className="text-sm md:text-lg text-[#1A2236] leading-relaxed">
              <span className="font-semibold">
                RiverEnergia was operating multiple business verticals without a unified automation backbone.
              </span>{' '}
              ...
              <span className="font-semibold text-[#0E9BF0]">
                {' '}
                GHL Scale Up architected a parent SaaS structure inside GoHighLevel, letting them manage multiple CRM brands under a single, branded ecosystem with AI-driven automation cutting lead response time to under a minute.
              </span>
            </p>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-6 md:mb-8">
            ...
            <p className="text-sm md:text-base text-[#5C6880] mt-2 max-w-2xl mx-auto">
              See how we unified multiple business verticals under one GoHighLevel parent SaaS system with AI-driven automation.
            </p>
          </div>
          ...
          <div className="relative w-full aspect-video bg-[#0B1628] rounded-xl overflow-hidden shadow-lg border border-[#DDE1E9]">
            <iframe
              ...
              title="GHL Scale Up Client Testimonial RiverEnergia Parent SaaS Case Study"
          ...
          <div className="grid sm:grid-cols-2 gap-4 mt-6">
            <div className="bg-white border border-[#DDE1E9] rounded-xl p-4 hover:shadow-lg transition-all">
              ...
              <p className="text-sm text-[#5C6880]">
                RiverConnect branded hub for managing all CRM brands
              </p>
            </div>
            <div className="bg-white border border-[#DDE1E9] rounded-xl p-4 hover:shadow-lg transition-all">
              <div className="flex items-center gap-3 mb-2">
              ...
              <p className="text-sm text-[#5C6880]">
                Custom domain setup for parent and sub-accounts
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4 mt-4">
              <div className="bg-[#F8F9FB] rounded-lg p-4 border border-[#DDE1E9]">
                <div className="flex items-center gap-2 mb-2">
                  <CheckCircle className="w-4 h-4 text-[#25C97D]" aria-hidden="true" />
                  <span className="font-semibold text-[#1A2236] text-sm">
                    Consistent Rollouts
                  </span>
                </div>
                <p className="text-sm text-[#5C6880]">
                  Every new sub-account inherits proven pipelines and workflows
                </p>
              </div>
              <div className="bg-[#F8F9FB] rounded-lg p-4 border border-[#DDE1E9]">
                <div className="flex items-center gap-2 mb-2">
                ...
                <p className="text-sm text-[#5C6880]">
                  No need to rebuild automation logic from scratch each time
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-white p-4 md:p-6 rounded-xl shadow-sm border border-[#DDE1E9]">
            ...
            <div className="grid sm:grid-cols-3 gap-4 mt-4">
              <div className="bg-[#F8F9FB] rounded-lg p-4 border border-[#DDE1E9] text-center">
                <div className="w-12 h-12 rounded-full bg-[#F8F9FB] flex items-center justify-center mx-auto mb-3">
                  <DollarSign className="w-6 h-6 text-[#0E9BF0]" aria-hidden="true" />
                </div>
                <h3 className="font-semibold text-[#1A2236] text-sm">Stripe</h3>
                <p className="text-xs text-[#5C6880] mt-1">Payment processing</p>
              </div>
              <div className="bg-[#F8F9FB] rounded-lg p-4 border border-[#DDE1E9] text-center">
                <div className="w-12 h-12 rounded-full bg-[#F8F9FB] flex items-center justify-center mx-auto mb-3">
                  <MessageSquare className="w-6 h-6 text-[#0E9BF0]" aria-hidden="true" />
                </div>
                <h3 className="font-semibold text-[#1A2236] text-sm">Twilio</h3>
                <p className="text-xs text-[#5C6880] mt-1">SMS &amp; Voice</p>
              </div>
              <div className="bg-[#F8F9FB] rounded-lg p-4 border border-[#DDE1E9] text-center">
                <div className="w-12 h-12 rounded-full bg-[#F8F9FB] flex items-center justify-center mx-auto mb-3">
                  <Mail className="w-6 h-6 text-[#0E9BF0]" aria-hidden="true" />
                </div>
                <h3 className="font-semibold text-[#1A2236] text-sm">Mailgun</h3>
            ...
            <div className="mt-4 bg-[#F8F9FB] rounded-lg p-4 border border-[#0E9BF0]/20">
              <p className="text-sm text-[#5C6880] leading-relaxed">
                <strong className="text-[#1A2236]">
                  Centralising these at the parent-account level
                </strong>{' '}
                meant RiverEnergia didn&apos;t need to reconfigure payment and messaging infrastructure separately for each CRM brand.
              </p>
            </div>
          </div>
        </div>
                ...
                <React.Fragment key={idx}>
                  <div
                    className={`px-4 py-2 rounded-full text-sm font-semibold ${
                      stage.color === 'blue'
                        ? 'bg-[#F8F9FB] text-[#0E9BF0] border border-[#0E9BF0]/30'
                        : stage.color === 'yellow'
                          ? 'bg-[#FFFBE6] text-[#8B6B00] border border-[#F8D000]/30'
                          : stage.color === 'orange'
                            ? 'bg-[#FFF5E6] text-[#B85C00] border border-[#F8A000]/30'
                            : stage.color === 'green'
                              ? 'bg-[#E6FAF2] text-[#1A7A4A] border border-[#25C97D]/30'
                  ...
                  {idx < pipelineStages.length - 1 && (
                    <ArrowRight
                      className="w-4 h-4 text-[#5C6880] flex-shrink-0"
                      aria-hidden="true"
                    />
                  )}
                </React.Fragment>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-[500px] md:min-w-full divide-y divide-[#DDE1E9]">
                <caption className="sr-only">
                  RiverEnergia GoHighLevel parent SaaS build outcomes by delivered component
                </caption>
                <thead className="bg-[#F8F9FB]">
                  <tr>
                    <th
                      scope="col"
                      className="px-4 md:px-6 py-3 md:py-4 text-left text-xs md:text-sm font-semibold text-[#1A2236]"
                    >
                      What we built
                    </th>
                    <th
                ...
                <tbody className="divide-y divide-[#DDE1E9]">
                  {results.map((result, index) => (
                    ...
                    >
                      <td className="px-4 md:px-6 py-3 md:py-4 text-xs md:text-sm font-medium text-[#1A2236]">
                        {result.metric}
                      </td>
                      <td className="px-4 md:px-6 py-3 md:py-4 text-xs md:text-sm text-[#5C6880]">
                        {result.outcome}
                      </td>
                    </tr>
                  ))}
            ...
            <div className="bg-red-50 border border-red-200 rounded-xl p-6">
              <div className="flex items-center gap-2 mb-4">
                <div className="w-8 h-8 rounded-full bg-red-100 flex items-center justify-center">
                  <span className="text-red-600 font-bold text-sm" aria-hidden="true">
                    ✕
                  </span>
                </div>
          ...
          <div className="bg-white p-4 md:p-6 rounded-xl shadow-sm border border-[#DDE1E9]">
            ...
            <div className="mt-4 grid sm:grid-cols-2 gap-4">
              <div className="bg-[#F8F9FB] rounded-lg p-4 border border-[#0E9BF0]/20">
                <div className="flex items-center gap-2 mb-2">
                  <Shield className="w-4 h-4 text-[#0E9BF0]" aria-hidden="true" />
                  <span className="font-semibold text-[#1A2236] text-sm">
                    Brand Separation
                  </span>
                </div>
                <p className="text-sm text-[#5C6880]">
                  Each CRM brand looks and operates as a distinct client experience
                </p>
              </div>
              <div className="bg-[#F8F9FB] rounded-lg p-4 border border-[#0E9BF0]/20">
                <div className="flex items-center gap-2 mb-2">
                  <Layers className="w-4 h-4 text-[#0E9BF0]" aria-hidden="true" />
                  <span className="font-semibold text-[#1A2236] text-sm">
                    Operational Consolidation
                  </span>
                </div>
                <p className="text-sm text-[#5C6880]">
                  Payments, messaging, and pipeline logic don&apos;t need to be rebuilt per brand
                </p>
              </div>
            </div>
          </div>
