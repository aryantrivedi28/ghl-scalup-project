// app/case-studies/gohighlevel-ai-automation-customer-management-marketing-agency/CaseStudyContent.tsx
'use client';
      ...
      <div className="max-w-[760px] mx-auto relative z-10">
        ...
        >
          ...
          <span className="text-[#F8D000]">
            How GHL Scale Up Cut Manual Workload by 70% for a Marketing Agency
          </span>
        </h1>

        <div className="flex flex-wrap items-center gap-3 mb-6">
          <div className="w-7 h-7 overflow-hidden bg-white flex items-center justify-center rounded">
            <Image
        ...
        <div className="bg-white/5 border border-white/10 rounded-xl p-4 md:p-5 mb-6 overflow-x-auto">
          ...
          <table className="w-full text-sm border-collapse">
            <caption className="sr-only">
              Before and after comparison of the GoHighLevel agency system build for Capviax
            </caption>
            <thead>
        ...
        <div className="flex flex-wrap gap-3">
          <Link
            ...
            aria-label="Get a free GoHighLevel agency consultation"
          >
          ...
          <div className="pl-2 md:pl-4">
            <p className="text-sm md:text-lg text-[#1A2236] leading-relaxed">
              <span className="font-semibold">
                A performance marketing agency was relying on disconnected tools and manual workflows to manage leads, clients, and communication.
              </span>{' '}
              ...
              <span className="font-semibold text-[#0E9BF0]">
                {' '}
                GHL Scale Up designed and implemented a complete GoHighLevel agency system with AI-powered workflows, centralizing customer management and automating lead response, scheduling, and follow-ups reducing manual operational workload by 70%.
              </span>
            </p>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-6 md:mb-8">
            ...
            <p className="text-sm md:text-base text-[#5C6880] mt-2 max-w-2xl mx-auto">
              See how we transformed this marketing agency&apos;s GoHighLevel system with AI-powered automation, cutting manual workload by 70%.
            </p>
          </div>
          ...
          <div className="relative w-full aspect-video bg-[#0B1628] rounded-xl overflow-hidden shadow-lg border border-[#DDE1E9]">
            <iframe
              ...
              title="GHL Scale Up Client Testimonial Capviax AI Automation Case Study"
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-white p-4 md:p-6 rounded-xl shadow-sm border border-[#DDE1E9]">
            ...
            <h3 className="font-semibold text-[#1A2236] text-base mb-3">
              The Initial Challenge: Manual Processes Couldn&apos;t Keep Pace With Agency Growth
            </h3>
            <p className="text-sm md:text-base text-[#5C6880] leading-relaxed mb-4">
            ...
            <div className="space-y-3">
              <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                <div className="flex items-start gap-3">
                  <div className="flex-shrink-0 w-8 h-8 bg-red-100 rounded-lg flex items-center justify-center">
                    <Zap className="w-4 h-4 text-red-600" aria-hidden="true" />
                  </div>
                  <div>
                    ...
                    <p className="text-sm text-[#5C6880]">
                      since incoming leads were being handled manually rather than routed and responded to automatically.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#5C6880]">
                      because there was no centralized system tracking where each lead or client stood in the pipeline.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-[#1A2236] text-sm">
                      A heavy operational workload
                    </h4>
                    <p className="text-sm text-[#5C6880]">
                      with team members spending time on repetitive tasks data entry, scheduling, follow-up messages that could have been automated.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="mt-6 bg-white p-4 md:p-6 rounded-xl shadow-sm border border-[#DDE1E9]">
            <h3 className="font-semibold text-[#1A2236] text-base mb-3">
              Why This Happens to Growing Marketing Agencies on GoHighLevel
            </h3>
            <p className="text-sm md:text-base text-[#5C6880] leading-relaxed mb-4">
            ...
            <ul className="space-y-2 text-sm text-[#5C6880]">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong className="text-[#1A2236]">No centralized customer management system.</strong> Without a structured system inside GoHighLevel for tracking leads and clients, teams fall back on spreadsheets, inboxes, or disconnected point tools.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-[#0E9BF0] flex-shrink-0 mt-0.5" aria-hidden="true" />
                <span>
                  <strong className="text-[#1A2236]">No AI-powered response layer.</strong> Manual lead response is the biggest bottleneck for agencies every minute of delay measurably lowers lead conversion, and a human team can&apos;t match instant automated response at scale.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-[#0E9BF0] flex-shrink-0 mt-0.5" aria-hidden="true" />
                <span>
                  <strong className="text-[#1A2236]">Fragmented pipelines and workflows.</strong> Without properly mapped pipelines, triggers, and automations built for agency-specific processes (client onboarding, service delivery, retention), GoHighLevel ends up used as a basic inbox rather than an operating system for the business.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-[#0E9BF0] flex-shrink-0 mt-0.5" aria-hidden="true" />
                <span>
                  <strong className="text-[#1A2236]">Manual nurturing.</strong> Sending follow-up emails and SMS one-by-one instead of through automated sequences caps how many leads and clients an agency can meaningfully stay in touch with.
                </span>
              </li>
            </ul>
          </div>
...
function AgencySystemBuildSection() {
  return (
    <section
      id="agency-system-build"
      aria-labelledby="agency-build-heading"
      className="py-16 md:py-20 bg-[#F8F9FB]"
    >
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-white p-4 md:p-6 rounded-xl shadow-sm border border-[#DDE1E9]">
            ...
            <div className="grid sm:grid-cols-3 gap-4 mt-4">
              <div className="bg-[#F8F9FB] rounded-lg p-4 border border-[#DDE1E9] text-center">
                ...
                <h3 className="font-semibold text-[#1A2236] text-sm">Brand Setup</h3>
                <p className="text-xs text-[#5C6880]">Full agency branding configuration</p>
              </div>
              <div className="bg-[#F8F9FB] rounded-lg p-4 border border-[#DDE1E9] text-center">
                <div className="w-10 h-10 rounded-full bg-[#F8F9FB] flex items-center justify-center mx-auto mb-2">
                  <Layers className="w-5 h-5 text-[#0E9BF0]" aria-hidden="true" />
                </div>
                <h3 className="font-semibold text-[#1A2236] text-sm">Pipelines</h3>
                <p className="text-xs text-[#5C6880]">Custom pipelines for agency workflows</p>
              </div>
              <div className="bg-[#F8F9FB] rounded-lg p-4 border border-[#DDE1E9] text-center">
                <div className="w-10 h-10 rounded-full bg-[#F8F9FB] flex items-center justify-center mx-auto mb-2">
                  <Settings2 className="w-5 h-5 text-[#0E9BF0]" aria-hidden="true" />
                </div>
                <h3 className="font-semibold text-[#1A2236] text-sm">Automations</h3>
...
function CustomerManagementSection() {
  return (
    <section
      ...
      aria-labelledby="customer-mgmt-heading"
      className="py-16 md:py-20"
    >
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-white p-4 md:p-6 rounded-xl shadow-sm border border-[#DDE1E9]">
            ...
            <div className="grid sm:grid-cols-3 gap-4 mt-4">
              <div className="bg-[#F8F9FB] rounded-lg p-4 border border-[#DDE1E9] text-center">
                <div className="w-10 h-10 rounded-full bg-[#F8F9FB] flex items-center justify-center mx-auto mb-2">
                  <Zap className="w-5 h-5 text-[#0E9BF0]" aria-hidden="true" />
                </div>
                <h3 className="font-semibold text-[#1A2236] text-sm">Instant Lead Response</h3>
                <p className="text-xs text-[#5C6880]">AI-powered engagement the moment leads come in</p>
              </div>
              <div className="bg-[#F8F9FB] rounded-lg p-4 border border-[#DDE1E9] text-center">
                <div className="w-10 h-10 rounded-full bg-[#F8F9FB] flex items-center justify-center mx-auto mb-2">
                  <Calendar className="w-5 h-5 text-[#0E9BF0]" aria-hidden="true" />
                </div>
                <h3 className="font-semibold text-[#1A2236] text-sm">Automated Scheduling</h3>
                <p className="text-xs text-[#5C6880]">Scheduling runs automatically at the right stage</p>
              </div>
              <div className="bg-[#F8F9FB] rounded-lg p-4 border border-[#DDE1E9] text-center">
                <div className="w-10 h-10 rounded-full bg-[#F8F9FB] flex items-center justify-center mx-auto mb-2">
                  <MessageSquare className="w-5 h-5 text-[#0E9BF0]" aria-hidden="true" />
                </div>
                <h3 className="font-semibold text-[#1A2236] text-sm">Automated Follow-Ups</h3>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="overflow-x-auto">
            <table className="w-full border-collapse text-sm">
              <caption className="sr-only">
                Six-stage GoHighLevel AI automation build implementation process for Capviax
              </caption>
              <thead>
...
function ResultsSection() {
  const results: React.ReactNode[] = [
    ...
    <span key="5">
      <strong className="text-[#1A2236]">Reduced manual operational workload by 70%</strong> through end-to-end automation
    </span>,
...
function RelatedCaseStudies() {
  const related = [
    ...
    {
      title: 'GoHighLevel Website Setup & Automation Fix',
  ...
  const faqs = [
    {
      ...
      answer:
        "By centralizing lead and client management inside GoHighLevel and building out pipelines, workflows, and triggers around the agency's actual processes, then layering AI-powered automation on top for lead response, scheduling, and follow-ups. Capviax reduced manual operational workload by 70% using this approach.",
    },
    {
      question: 'What is an AI-powered workflow in GoHighLevel?',
      answer:
        'An AI-powered workflow in GoHighLevel uses automation and AI tools to handle tasks like responding to new leads instantly, booking appointments, and sending follow-up messages without a team member manually initiating each step.',
    },
    {
      question: 'How does AI lead response work in GoHighLevel?',
      answer:
        'When a new lead enters the system through a form, survey, or ad an AI-powered workflow can respond immediately, qualify the lead through conversation, and route it to the appropriate pipeline stage or team member, removing the delay of manual response.',
    },
    {
      question: 'What is a centralized customer management system inside GoHighLevel?',
      answer:
        "It's a structured setup inside GoHighLevel built around custom pipelines, tags, and workflows that tracks every lead and client from first contact through onboarding and ongoing service, replacing the need for separate spreadsheets or disconnected tools.",
    },
    {
      question: 'Can GoHighLevel automate both email and SMS follow-ups for client retention?',
      answer:
        "Yes. GoHighLevel supports automated, triggered email and SMS sequences that can be built around a lead's or client's stage in the pipeline, keeping nurturing and retention communication consistent without manual sending.",
    },
    {
      question: 'Is GoHighLevel suitable for marketing agencies managing high lead volume?',
      answer:
        'Yes, when the account is properly built out for agency-scale operations with dedicated pipelines, automated lead routing, and AI-powered response workflows GoHighLevel can handle significantly higher lead and client volume than a manually managed setup.',
    },
    {
      question: 'How long does it take to build a full GoHighLevel automation system for an agency?',
      answer:
        "Timelines depend on the complexity of the agency's existing processes and how many pipelines, workflows, and integrations are required, but a full agency system build typically starts with mapping current processes before building pipelines, automations, and AI workflows from the ground up.",
    },
    {
      question: 'What causes agencies to rely on manual processes instead of automation in GoHighLevel?',
      answer:
        "This usually happens when a GoHighLevel account is set up with default or minimal configuration rather than being built around the agency's specific lead management, onboarding, and retention workflows, leaving teams to fill the gaps manually.",
    },
  ];
