// app/case-studies/gohighlevel-website-setup-automation-fix/CaseStudyContent.tsx
'use client';
      ...
      <div className="max-w-[760px] mx-auto relative z-10">
        ...
        >
          ...
          <span className="text-[#F8D000]">
            How GHL Scale Up Rebuilt a Broken System for a Service-Based Business
          </span>
        </h1>
        ...
        <div className="bg-white/5 border border-white/10 rounded-xl p-4 md:p-5 mb-6 overflow-x-auto">
          ...
          <table className="w-full text-sm border-collapse">
            <caption className="sr-only">
              Before and after comparison of the GoHighLevel system rebuild for a service-based business
            </caption>
            <thead>
        ...
        <div className="flex flex-wrap gap-3">
          <Link
            ...
            aria-label="Get a free GoHighLevel system audit"
          >
          ...
          <div className="pl-2 md:pl-4">
            <p className="text-sm md:text-lg text-[#1A2236] leading-relaxed">
              <span className="font-semibold">
                A service-based business had adopted GoHighLevel but was suffering from broken surveys, unreliable email automation, and inconsistent campaign delivery.
              </span>{' '}
              ...
              <span className="font-semibold text-[#0E9BF0]">
                {' '}
                GHL Scale Up diagnosed the broken systems, built a custom GoHighLevel website, and rebuilt the automation from the ground up — establishing a reliable end-to-end communication system.
              </span>
            </p>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-6 md:mb-8">
            ...
            <p className="text-sm md:text-base text-[#5C6880] mt-2 max-w-2xl mx-auto">
              See how we transformed this service-based business&apos;s GoHighLevel system from broken automations to a fully functioning website and automation platform.
            </p>
          </div>
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-white p-4 md:p-6 rounded-xl shadow-sm border border-[#DDE1E9]">
            ...
            <h3 className="font-semibold text-[#1A2236] text-base mb-3">
              The Initial Challenge: A GoHighLevel System That Wasn&apos;t Working as Intended
            </h3>
            <p className="text-sm md:text-base text-[#5C6880] leading-relaxed mb-4">
            ...
            <div className="space-y-3">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-[#1A2236] text-sm">
                      GoHighLevel surveys were not functioning correctly
                    </h4>
                    <p className="text-sm text-[#5C6880]">
                      which meant lead and client data collected through forms and surveys couldn&apos;t be trusted.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-[#1A2236] text-sm">
                      GoHighLevel email automation workflows were broken
                    </h4>
                    <p className="text-sm text-[#5C6880]">
                      so triggered sequences — onboarding emails, follow-ups, nurture sequences — either failed to fire or fired incorrectly.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-[#1A2236] text-sm">
                      Campaign delivery was inconsistent
                    </h4>
                    <p className="text-sm text-[#5C6880]">
                      meaning email campaigns sent through GoHighLevel were not reliably reaching client inboxes.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="mt-6 bg-white p-4 md:p-6 rounded-xl shadow-sm border border-[#DDE1E9]">
            <h3 className="font-semibold text-[#1A2236] text-base mb-3">
              Why GoHighLevel Automation Breaks Down in the First Place
            </h3>
            <p className="text-sm md:text-base text-[#5C6880] leading-relaxed mb-4">
            ...
            <ul className="space-y-2 text-sm text-[#5C6880]">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong className="text-[#1A2236]">Survey and form logic errors.</strong> GoHighLevel surveys rely on correctly mapped custom fields and conditional logic. A single misconfigured field mapping can cause a survey to submit without triggering the intended workflow.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-[#0E9BF0] flex-shrink-0 mt-0.5" aria-hidden="true" />
                <span>
                  <strong className="text-[#1A2236]">Workflow trigger conflicts.</strong> When multiple workflows are built over time without a clear map of triggers and exit conditions, contacts can end up in the wrong workflow, get stuck, or trigger duplicate automations.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-[#0E9BF0] flex-shrink-0 mt-0.5" aria-hidden="true" />
                <span>
                  <strong className="text-[#1A2236]">Email deliverability configuration gaps.</strong> Inconsistent campaign delivery in GoHighLevel is frequently tied to sending domain authentication (SPF, DKIM, DMARC), sender reputation, or workflow-level throttling issues rather than the platform itself.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-[#0E9BF0] flex-shrink-0 mt-0.5" aria-hidden="true" />
                <span>
                  <strong className="text-[#1A2236]">No dedicated GoHighLevel website.</strong> Businesses using external website builders alongside GoHighLevel often lose data continuity between the site and the CRM, since forms and tracking aren&apos;t natively integrated.
                </span>
              </li>
            </ul>
            <p className="text-sm md:text-base text-[#5C6880] leading-relaxed mt-4">
...
function WebsiteBuildSection() {
  return (
    <section
      id="website-build"
      aria-labelledby="website-build-heading"
      className="py-16 md:py-20 bg-[#F8F9FB]"
    >
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 gap-4 mt-4">
              <div className="bg-[#F8F9FB] rounded-lg p-4 border border-[#DDE1E9]">
                <div className="flex items-center gap-2 mb-2">
                  <Globe className="w-4 h-4 text-[#0E9BF0]" aria-hidden="true" />
                  <span className="font-semibold text-[#1A2236] text-sm">
                    Native Integration
                  </span>
                </div>
                <p className="text-sm text-[#5C6880]">
                  Every form submission feeds directly into GoHighLevel CRM
                </p>
              </div>
              <div className="bg-[#F8F9FB] rounded-lg p-4 border border-[#DDE1E9]">
                <div className="flex items-center gap-2 mb-2">
                  <Zap className="w-4 h-4 text-[#0E9BF0]" aria-hidden="true" />
                  <span className="font-semibold text-[#1A2236] text-sm">
                    No Sync Delays
                  </span>
                </div>
                <p className="text-sm text-[#5C6880]">
                  Eliminates reliance on third-party integrations or webhooks
                </p>
              </div>
            </div>
          </div>
...
function SurveyFixSection() {
  return (
    <section
      id="survey-fix"
      aria-labelledby="survey-fix-heading"
      className="py-16 md:py-20"
    >
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
...
function WorkflowRebuildSection() {
  return (
    <section
      id="workflow-rebuild"
      aria-labelledby="workflow-rebuild-heading"
      className="py-16 md:py-20 bg-[#F8F9FB]"
    >
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
...
function CustomWorkflowsSection() {
  return (
    <section
      id="custom-workflows"
      aria-labelledby="custom-workflows-heading"
      className="py-16 md:py-20 bg-[#F8F9FB]"
    >
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="overflow-x-auto">
            <table className="w-full border-collapse text-sm">
              <caption className="sr-only">
                Six-stage GoHighLevel website and automation rebuild implementation process
              </caption>
              <thead>
  ...
  const faqs = [
    {
      ...
      answer:
        "This is usually caused by incorrect custom field mapping, conditional logic errors within the survey builder, or a workflow trigger that isn't correctly linked to the survey's submission event. A full audit of the survey's field mapping and its connected workflow is the fastest way to isolate the cause.",
    },
    {
      question: 'Why is my GoHighLevel email automation not sending or sending inconsistently?',
      answer:
        "Common causes include conflicting workflow triggers, contacts entering a workflow at the wrong step, workflow 'if/else' branches with missing exit paths, or account-level sending limits. Reviewing the workflow's trigger and action history in GoHighLevel usually reveals where contacts are getting stuck.",
    },
    {
      question: 'Why are my GoHighLevel email campaigns not reaching inboxes consistently?',
      answer:
        'Inconsistent campaign delivery is typically tied to sending domain authentication (SPF, DKIM, DMARC not fully configured), a damaged sender reputation, or campaign sending speed that triggers spam filtering. Deliverability issues need to be diagnosed at the domain and account level, not just the campaign level.',
    },
    {
      question: 'Should I build my website directly inside GoHighLevel or connect an external website?',
      answer:
        'Building the website natively inside GoHighLevel keeps lead capture, forms, and tracking connected to the CRM without relying on third-party integrations or webhooks that can fail silently. For service-based businesses that depend on GoHighLevel for client communication, this reduces the risk of losing leads or data between systems.',
    },
    {
      question: 'How long does it take to fix a broken GoHighLevel automation system?',
      answer:
        'Timelines vary depending on how many workflows, surveys, and integrations are involved, but the process generally starts with a full account audit, followed by targeted fixes to the highest-impact broken workflows before a full rebuild of sign-up and follow-up sequences.',
    },
    {
      question: 'What is included in a GoHighLevel automation audit?',
      answer:
        'A GoHighLevel automation audit typically reviews workflow trigger and exit logic, custom field and tag mapping, survey and form configuration, email sending domain authentication, and campaign delivery settings to identify where the system is breaking down.',
    },
    {
      question: 'Can GoHighLevel handle both website hosting and CRM automation for a service business?',
      answer:
        'Yes. GoHighLevel supports building and hosting a full website alongside CRM, workflow automation, and campaign tools, which allows a service-based business to run lead capture, client onboarding, and follow-up communication from a single connected system.',
    },
  ];
