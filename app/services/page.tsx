...
import {
  Wrench, Bot, FileText, Globe, Mail, Phone, Calendar, Star, Settings,
  Link as LinkIcon, BarChart, RefreshCw, GraduationCap, Users, Target, Zap,
  TrendingUp, Clock, Briefcase, Award, Headphones, ChevronRight, CheckCircle,
  MessageSquare, Building2, UserCheck, Layers, Database, Rocket, Search,
  Lightbulb, TestTube, ArrowRight, HelpCircle, Workflow, BarChart3,
  Settings2, Megaphone, LifeBuoy,
} from 'lucide-react';
...
export const metadata = {
  ...
  description:
    'Explore GoHighLevel services from GHL Scale Up, including CRM setup, automation, funnels, AI, SaaS, migration, integrations, websites and ongoing GHL support.',
  keywords:
    'GoHighLevel services, GHL services, GoHighLevel service provider, GoHighLevel implementation services, GoHighLevel solutions, GoHighLevel experts, GoHighLevel setup services',
  alternates: { canonical: '/services' },
  openGraph: {
    title: 'GoHighLevel Services Built Around Your Business | GHL Scale Up',
    description:
      'CRM, automation, AI, migration, SaaS, integrations and more implemented around how your business actually operates.',
...
export default async function ServicesPage() {
  ...
  // ============================================
  // DATA (all content preserved no omissions)
  // ============================================
  const stats = [
  ...
  const businessModels = [
    { title: 'Real Estate', description: 'Lead capture → property inquiry → qualification → agent assignment → follow-up → appointment → opportunity → closing.', icon: Building2 },
    { title: 'Coaches & Consultants', description: 'Lead magnet → application → qualification → consultation → nurture → enrollment → onboarding.', icon: UserCheck },
    { title: 'Agencies', description: 'Internal growth systems plus client delivery systems, including CRM architecture, reusable workflows, snapshots, SaaS, reporting, onboarding, and account management.', icon: Briefcase },
    { title: 'Lead-Driven Service Businesses', description: 'Lead Capture → Instant Response → Qualification → Booking → Sales Pipeline → Follow-Up → Review → Re-engagement.', icon: Zap },
  ];
  ...
  const faqs = [
    { question: 'What are GoHighLevel services?', answer: 'GoHighLevel services cover the strategy, setup, implementation, automation, integration, migration, and ongoing management required to turn GoHighLevel into a functioning business system. This includes CRM setup, workflow automation, funnel development, AI implementation, SaaS configuration, and more.' },
    { question: 'What does a GoHighLevel service provider do?', answer: 'A GoHighLevel service provider helps businesses design, build, and manage their GoHighLevel system. This includes CRM configuration, pipeline setup, workflow automation, funnel and website development, AI implementation, integrations, migration from other platforms, team training, and ongoing account management.' },
    { question: 'Can you set up GHL from scratch?', answer: 'Yes. We handle complete GoHighLevel setup from scratch, including CRM configuration, pipeline design, calendar setup, workflow automation, funnel development, website building, and everything else required to launch your system.' },
    { question: 'Can you migrate my CRM?', answer: 'Yes. We provide complete GoHighLevel migration services from platforms including HubSpot, ActiveCampaign, ClickFunnels, Kajabi, Mailchimp, and others. Migration includes source-platform auditing, contact and field mapping, pipeline reconstruction, workflow recreation, forms and funnel rebuilding, integration reconnection, tracking setup, testing, team training, and cutover planning.' },
    { question: 'Can you build workflows?', answer: 'Yes. We build trigger-based GoHighLevel workflows around real business events such as form submissions, bookings, pipeline changes, missed appointments, customer conversion, inactivity, review milestones, and reactivation.' },
    { question: 'Can you integrate GHL?', answer: 'Yes. We connect GoHighLevel with your existing tools using native integrations, automation platforms, webhooks, and APIs. We use native integrations where they are sufficient and build around APIs or webhooks where the workflow requires something more specific.' },
    { question: 'Can you set up AI?', answer: 'Yes. We implement AI Chatbot and Conversation AI for FAQ handling, lead qualification, information collection, appointment booking, and customer support. We also implement AI Voice Agents for inbound call handling, lead qualification, appointment booking, and missed-call follow-up.' },
    { question: 'Can you build SaaS?', answer: 'Yes. We configure White-Label GoHighLevel SaaS setups including branded domains, snapshots, billing, sub-account provisioning, and the supporting infrastructure required for a branded SaaS offering.' },
    { question: 'Can you manage GHL after setup?', answer: 'Yes. We provide ongoing GoHighLevel management and virtual assistant services to support day-to-day account tasks, campaigns, pipeline updates, account maintenance, and other operational work inside GHL.' },
    { question: 'Do you provide training?', answer: 'Yes. We provide role-based GoHighLevel training, SOPs, documentation, recorded sessions, and live training where required.' },
    { question: 'Can you customize GHL for my industry?', answer: 'Yes. We build GoHighLevel systems around how your specific business operates. We have experience across real estate, coaching, consulting, agencies, and lead-driven service businesses, and we customize the system to match your sales process and customer journey.' },
    { question: 'Do I need all these services?', answer: 'No. You do not need every feature inside GoHighLevel. You need the right features, connected in the right way, around the way your business operates. We help you determine what your GoHighLevel system actually needs based on your goals, sales process, and customer journey.' },
    { question: 'Can you work with an existing GHL account?', answer: 'Yes. We can audit, reconfigure, and optimize an existing GoHighLevel account. If your account is messy or underused, we can rebuild the structure, fix broken workflows, and align the system with your sales process.' },
    { question: 'How much does implementation cost?', answer: 'Implementation cost depends on the scope of your project, the complexity of your requirements, and the services you need. Book a free strategy call and we will understand your needs, recommend the right services, and provide a fixed-price quote.' },
  ];
    ...
    <>
      ...
      <section className="bg-gradient-to-b from-[#1C2E4A] to-[#111E30] text-white relative overflow-hidden">
        ...
        <div className={`${container} relative z-10 py-16 md:py-24`}>
          ...
          {/* Stats */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-12 md:mt-16 pt-8 border-t border-white/10">
      ...
      {/* ============================================
          WHAT ARE GOHIGHLEVEL SERVICES? two column
          ============================================ */}
          ...
          <div className="grid lg:grid-cols-[1fr_1.4fr] gap-8 lg:gap-16 items-start">
            <div className="lg:sticky lg:top-24">
              <h2 className="text-2xl md:text-3xl font-extrabold text-[#1C2E4A] leading-tight">
                What Are <span className="text-[#0E9BF0]">GoHighLevel Services?</span>
              </h2>
            </div>
            <div className="space-y-4">
              <p className="text-[0.92rem] sm:text-[0.95rem] text-[#4A5568] leading-relaxed">
                GoHighLevel services cover the strategy, setup, implementation, automation, integration, migration, and ongoing management required to turn GoHighLevel into a functioning business system.
              </p>
              <p className="text-[0.92rem] sm:text-[0.95rem] text-[#4A5568] leading-relaxed">
                For one business, that may mean setting up a clean CRM and sales pipeline. For another, it may mean migrating from HubSpot or ActiveCampaign, rebuilding workflows, connecting forms and calendars, and training the team.
              </p>
              <p className="text-[0.92rem] sm:text-[0.95rem] text-[#4A5568] leading-relaxed">
                For an agency, it could mean building a white-label SaaS environment with reusable snapshots, branded domains, billing, and automated account provisioning.
              </p>
              <p className="text-[0.92rem] sm:text-[0.95rem] text-[#4A5568] leading-relaxed">
                For a growing service business, the priority may be connecting lead capture, instant follow-up, appointment booking, pipeline management, AI conversations, and reactivation into one customer journey.
              </p>
              <p className="text-[0.92rem] sm:text-[0.95rem] text-[#1C2E4A] font-semibold leading-relaxed pt-2">
              ...
              <div className="flex flex-wrap items-center gap-x-2 gap-y-3 text-[0.75rem] sm:text-[0.8rem] font-semibold text-[#0E9BF0] bg-[#F4F7FA] border border-[#E8EDF4] rounded-xl p-4">
                {['Lead Generation', 'Lead Capture', 'CRM', 'Qualification', 'Follow-Up', 'Booking', 'Sales', 'Onboarding', 'Retention', 'Reactivation'].map((step, i, arr) => (
                  <span key={step} className="flex items-center gap-2">
                    <span>{step}</span>
                    {i < arr.length - 1 && <ArrowRight className="h-3 w-3 text-[#0E9BF0]/60" />}
                  </span>
                ))}
              </div>
            </div>
        ...
        <div className={container}>
          <div className="text-center max-w-3xl mx-auto mb-10 md:mb-12">
            <h2 className="text-2xl md:text-3xl font-extrabold text-[#1C2E4A] mb-3">
              GoHighLevel Services for the{' '}
              <span className="text-[#0E9BF0]">Entire Customer Journey</span>
            </h2>
            <p className="text-[0.88rem] sm:text-[0.9rem] text-[#4A5568]">
              Every stage of the customer journey connected inside one system.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-5">
            {customerJourney.map((item, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-white border border-[#E8EDF4] rounded-2xl p-5 md:p-6 hover:shadow-[0_12px_40px_rgba(28,46,74,0.08)] hover:-translate-y-1 hover:border-[#0E9BF0] transition-all duration-300"
                >
                  <div className="w-11 h-11 rounded-lg bg-[rgba(14,155,240,0.1)] flex items-center justify-center mb-4">
                    <Icon className="h-5 w-5 text-[#0E9BF0]" />
                  </div>
                  <h3 className="text-[0.92rem] sm:text-[0.95rem] font-bold text-[#1C2E4A] mb-2">{item.stage}</h3>
                  <p className="text-[0.78rem] sm:text-[0.8rem] text-[#4A5568] leading-relaxed">{item.description}</p>
                </div>
              );
            })}
          </div>
      ...
      <section className="py-14 md:py-20 bg-white">
        <div className={container}>
          <div className="text-center max-w-3xl mx-auto mb-10 md:mb-12">
            <h2 className="text-2xl md:text-3xl font-extrabold text-[#1C2E4A] mb-3">
              Which GoHighLevel <span className="text-[#0E9BF0]">Service Do You Need?</span>
            </h2>
            <p className="text-[0.88rem] sm:text-[0.9rem] text-[#4A5568]">
              Find your situation and jump straight to the right service.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 gap-3 md:gap-4">
            {decisionGuide.map((item, index) => (
              <Link
                key={index}
                href={item.link}
                className="group flex items-center justify-between gap-3 sm:gap-4 bg-[#F4F7FA] border border-[#E8EDF4] rounded-xl p-4 sm:p-5 hover:border-[#0E9BF0] hover:bg-white hover:shadow-[0_8px_30px_rgba(14,155,240,0.1)] transition-all duration-300"
              >
                <div className="flex items-start gap-3 min-w-0">
                  <HelpCircle className="h-5 w-5 text-[#0E9BF0] flex-shrink-0 mt-0.5" />
                  <span className="text-[0.82rem] sm:text-[0.85rem] text-[#4A5568] leading-snug">{item.problem}</span>
                </div>
                <div className="flex items-center gap-1.5 flex-shrink-0">
                  <span className="text-[0.75rem] sm:text-[0.78rem] font-semibold text-[#1C2E4A] group-hover:text-[#0E9BF0] transition-colors hidden lg:inline">
                    {item.solution}
                  </span>
      ...
      <section className="py-14 md:py-20 bg-[#F4F7FA]">
        <div className={container}>
          <div className="text-center max-w-3xl mx-auto mb-10 md:mb-12">
            ...
            <p className="text-[0.88rem] sm:text-[0.9rem] text-[#4A5568]">
              Core building blocks that every GHL system needs.
            </p>
          </div>
            ...
            {foundationServices.map((service, index) => {
              ...
              return (
                <Link
                  key={index}
                  href={service.link}
                  className="group bg-white border border-[#E8EDF4] rounded-2xl p-5 md:p-6 hover:shadow-[0_12px_40px_rgba(28,46,74,0.08)] hover:-translate-y-1 hover:border-[#0E9BF0] transition-all duration-300 flex flex-col"
                >
                  <div className="w-12 h-12 rounded-xl bg-[rgba(14,155,240,0.1)] flex items-center justify-center mb-4 group-hover:bg-[rgba(14,155,240,0.2)] transition-colors">
                    <Icon className="h-6 w-6 text-[#0E9BF0]" />
                  </div>
                  <h3 className="text-[0.95rem] font-bold text-[#1C2E4A] group-hover:text-[#0E9BF0] transition-colors mb-2">
                    {service.title}
                  </h3>
                  <p className="text-[0.8rem] sm:text-[0.82rem] text-[#4A5568] leading-relaxed flex-1">{service.description}</p>
                  <div className="mt-4 inline-flex items-center gap-1 text-[0.72rem] font-semibold text-[#0E9BF0] group-hover:gap-2 transition-all">
      ...
      <section className="py-14 md:py-20 bg-white">
        <div className={container}>
            ...
            {automationServices.map((service, index) => {
              ...
              return (
                <Link
                  key={index}
                  href={service.link}
                  className="group bg-white border border-[#E8EDF4] rounded-2xl p-6 md:p-7 hover:shadow-[0_12px_40px_rgba(28,46,74,0.08)] hover:-translate-y-1 hover:border-[#0E9BF0] transition-all duration-300"
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-[0.82rem] sm:text-[0.85rem] text-[#4A5568] leading-relaxed">{service.description}</p>
                    </div>
                  </div>
                </Link>
              );
          ...
          <div className="mt-8 md:mt-10 text-center bg-[#F4F7FA] border border-[#E8EDF4] rounded-2xl p-5 sm:p-6 max-w-3xl mx-auto">
            <p className="text-[0.88rem] sm:text-[0.95rem] text-[#1C2E4A] font-semibold italic">
      ...
      {/* ============================================
          ...
          ============================================ */}
      <section className="bg-gradient-to-b from-[#111E30] to-[#1C2E4A] text-white py-14 md:py-20 relative overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_50%_50%_at_80%_30%,rgba(14,155,240,0.15),transparent)] pointer-events-none" />
        <div className={`${container} relative z-10`}>
          <div className="text-center max-w-3xl mx-auto mb-10 md:mb-12">
            <div className="inline-flex items-center gap-2 bg-white/5 border border-white/10 text-[#F8D000] text-[0.6rem] font-bold tracking-[0.12em] uppercase px-3 py-1.5 rounded-full mb-4">
              <Bot className="h-3 w-3" />
              AI & Voice
            </div>
            <h2 className="text-2xl md:text-3xl font-extrabold mb-3">
              Add AI to <span className="text-[#F8D000]">Customer Communication</span>
            </h2>
            <p className="text-[0.88rem] sm:text-[0.9rem] text-white/60 max-w-2xl mx-auto">
              AI that works inside your CRM not beside it.
            </p>
          </div>
            ...
            {aiServices.map((service, index) => {
              ...
              return (
                <Link
                  key={index}
                  href={service.link}
                  className="group bg-white/[0.04] backdrop-blur-sm border border-white/10 rounded-2xl p-6 md:p-7 hover:bg-white/[0.08] hover:border-[#F8D000]/40 hover:-translate-y-1 transition-all duration-300"
                >
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 rounded-xl bg-[rgba(248,208,0,0.12)] flex items-center justify-center flex-shrink-0 group-hover:bg-[rgba(248,208,0,0.2)] transition-colors">
                      <Icon className="h-6 w-6 text-[#F8D000]" />
                    </div>
                    <div>
                      <h3 className="text-[0.95rem] font-bold text-white group-hover:text-[#F8D000] transition-colors mb-2">
                        {service.title}
                      </h3>
                      <p className="text-[0.82rem] sm:text-[0.85rem] text-white/60 leading-relaxed">{service.description}</p>
                    </div>
                  </div>
                </Link>
              );
      ...
      <section className="py-14 md:py-20 bg-white">
        <div className={container}>
          <div className="grid lg:grid-cols-[1fr_1.4fr] gap-8 lg:gap-16 items-start">
            ...
            <div className="space-y-4">
              <p className="text-[0.92rem] sm:text-[0.95rem] text-[#4A5568] leading-relaxed">
                GoHighLevel rarely exists in isolation. Your business may depend on payment platforms, advertising systems, spreadsheets, scheduling tools, communication platforms, internal applications, or other software.
              </p>
              <p className="text-[0.92rem] sm:text-[0.95rem] text-[#4A5568] leading-relaxed">
                We can connect GHL with the tools around it using available integrations, automation platforms, webhooks, and APIs. Use native integrations where they are sufficient; build around APIs or webhooks where the workflow requires something more specific.
              </p>
              <Link
                href="/services/integrations"
                className="inline-flex items-center gap-2 text-[#0E9BF0] font-semibold text-[0.88rem] sm:text-[0.9rem] hover:gap-3 transition-all pt-2"
              >
        ...
        <div className={container}>
          <div className="grid lg:grid-cols-[1fr_1.4fr] gap-8 lg:gap-16 items-start">
            ...
            <div className="space-y-4">
              ...
              <p className="text-[0.92rem] sm:text-[0.95rem] text-[#4A5568] leading-relaxed">
                A migration can involve source-platform auditing, contact and field mapping, pipeline reconstruction, workflow recreation, forms and funnel rebuilding, integration reconnection, tracking setup, testing, team training, and cutover planning.
              </p>
              <p className="text-[0.82rem] sm:text-[0.85rem] text-[#4A5568] leading-relaxed italic">
                Source-specific migration pages should remain the deeper destinations for HubSpot, ClickFunnels, ActiveCampaign, Kajabi, Mailchimp, and other platform-specific searches.
              </p>
              <Link
          ...
          <div className="grid sm:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-5">
            {businessModels.map((model, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-[#F4F7FA] border border-[#E8EDF4] rounded-2xl p-5 md:p-6 hover:shadow-[0_12px_40px_rgba(28,46,74,0.08)] hover:-translate-y-1 transition-all duration-300 flex flex-col"
                >
                  <div className="w-11 h-11 rounded-xl bg-white flex items-center justify-center mb-4 border border-[#E8EDF4]">
                    <Icon className="h-5 w-5 text-[#0E9BF0]" />
                  </div>
                  <h3 className="text-[0.92rem] sm:text-[0.95rem] font-bold text-[#1C2E4A] mb-2">{model.title}</h3>
                  <p className="text-[0.78rem] sm:text-[0.8rem] text-[#4A5568] leading-relaxed">{model.description}</p>
                </div>
              );
            })}
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3 md:gap-4">
            {implementationAreas.map((area, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-white border border-[#E8EDF4] rounded-xl p-4 md:p-5 text-center hover:shadow-[0_8px_30px_rgba(28,46,74,0.06)] hover:border-[#0E9BF0] transition-all duration-300"
                >
                  <div className="w-11 h-11 rounded-lg bg-[rgba(14,155,240,0.1)] flex items-center justify-center mx-auto mb-3">
                    <Icon className="h-5 w-5 text-[#0E9BF0]" />
                  </div>
                  <span className="text-[0.72rem] sm:text-[0.75rem] font-semibold text-[#1C2E4A] leading-snug block">{area.title}</span>
                </div>
              );
            })}
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-5">
            {processSteps.map((item, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-[#F4F7FA] border border-[#E8EDF4] rounded-2xl p-5 md:p-6 hover:shadow-[0_12px_40px_rgba(28,46,74,0.08)] hover:-translate-y-1 hover:border-[#0E9BF0] transition-all duration-300"
                >
                  ...
                  <h3 className="text-[0.95rem] font-bold text-[#1C2E4A] mb-2">{item.title}</h3>
                  <p className="text-[0.8rem] sm:text-[0.82rem] text-[#4A5568] leading-relaxed">{item.description}</p>
                </div>
              );
            })}
          </div>
      ...
      <section className="py-14 md:py-20 bg-[#F4F7FA]">
        <div className={container}>
          <div className="text-center max-w-3xl mx-auto mb-10 md:mb-12">
            ...
            <h2 className="text-2xl md:text-3xl font-extrabold text-[#1C2E4A] mb-3">
              Why Businesses Trust <span className="text-[#0E9BF0]">GHL Scale Up</span>
            </h2>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6">
            {whyChooseUs.map((item, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-white border border-[#E8EDF4] rounded-2xl p-5 md:p-6 hover:shadow-[0_12px_40px_rgba(28,46,74,0.08)] hover:-translate-y-1 transition-all duration-300"
                >
                  <div
                    className={`w-14 h-14 rounded-full ${colorClasses[item.color as keyof typeof colorClasses]} flex items-center justify-center mb-4`}
                  >
                    <Icon className="h-7 w-7 text-[#1C2E4A]" />
                  </div>
                  <h3 className="text-[0.95rem] font-bold text-[#1C2E4A] mb-2">{item.title}</h3>
                  <p className="text-[0.82rem] sm:text-[0.85rem] text-[#4A5568] leading-relaxed">{item.description}</p>
                </div>
              );
            })}
          </div>
          ...
          <div className="mt-8 md:mt-10 text-center">
            <div className="inline-flex items-center gap-3 bg-white border border-[#E8EDF4] rounded-full px-5 sm:px-6 py-3">
              <Award className="h-4 w-4 text-[#F8D000]" />
              <span className="text-[0.8rem] sm:text-sm text-[#4A5568]">
        ...
        <div className={container}>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4">
            {whenToHire.map((item, index) => (
              <div
                key={index}
                className="flex items-start gap-3 bg-[#F4F7FA] border border-[#E8EDF4] rounded-xl p-4 hover:border-[#0E9BF0] transition-colors"
              >
                <CheckCircle className="h-5 w-5 text-[#0E9BF0] flex-shrink-0 mt-0.5" />
                <span className="text-[0.8rem] sm:text-[0.83rem] text-[#4A5568] leading-snug">{item}</span>
              </div>
            ))}
          </div>
        </div>
            ...
            {faqs.map((faq, index) => (
              ...
              >
                <summary className="flex items-center justify-between gap-4 p-4 sm:p-5 cursor-pointer hover:bg-[#F9FBFD] transition-colors list-none">
                  <span className="text-[0.85rem] sm:text-[0.9rem] font-semibold text-[#1C2E4A]">{faq.question}</span>
        ...
        <div className={`${container} relative z-10 py-16 md:py-24`}>
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-[1.6rem] sm:text-2xl md:text-3xl lg:text-4xl font-extrabold tracking-[-0.03em] leading-[1.2] mb-5">
              Build the GoHighLevel System{' '}
              <span className="text-[#F8D000]">Your Business Actually Needs</span>
            </h2>
            <p className="text-[0.9rem] sm:text-[0.95rem] font-light text-white/60 mb-3 leading-relaxed">
              You don't need every feature inside GoHighLevel. You need the right features, connected in the right way, around the way your business operates.
            </p>
            <p className="text-[0.9rem] sm:text-[0.95rem] font-light text-white/60 mb-8 leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center flex-wrap">
              ...
              <Link
                href="/contact"
                className="bg-transparent text-white px-6 sm:px-8 py-3 rounded-lg text-[0.88rem] sm:text-[0.9rem] font-medium border border-white/20 hover:border-white/30 hover:bg-white/5 transition-all inline-flex items-center justify-center gap-2"
              >
