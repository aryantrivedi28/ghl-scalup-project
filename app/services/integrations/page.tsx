          ...
          <div className="grid md:grid-cols-[1.2fr_0.8fr] gap-10 md:gap-14 items-center">
            ...
            <div>
              <div className="bg-white/10 border border-white/15 rounded-2xl p-6 md:p-8">
                <h3 className="text-[0.68rem] font-bold uppercase tracking-[0.08em] text-white/50 mb-5">Integration Results</h3>
                <div className="flex items-center gap-4 py-3 border-b border-white/10">
                  <div className="text-[1.4rem] font-extrabold text-[#F8D000] tracking-[-0.03em] min-w-[80px]">200+</div>
                  <div className="text-[0.78rem] text-white/50">Integrations built</div>
                </div>
                <div className="flex items-center gap-4 py-3 border-b border-white/10">
                  <div className="text-[1.4rem] font-extrabold text-[#F8D000] tracking-[-0.03em] min-w-[80px]">50+</div>
                  <div className="text-[0.78rem] text-white/50">Platforms connected</div>
                </div>
                <div className="flex items-center gap-4 py-3 border-b border-white/10">
                  <div className="text-[1.4rem] font-extrabold text-[#F8D000] tracking-[-0.03em] min-w-[80px]">100%</div>
                  <div className="text-[0.78rem] text-white/50">Data sync reliability</div>
                </div>
                <div className="flex items-center gap-4 py-3">
                  <div className="text-[1.4rem] font-extrabold text-[#F8D000] tracking-[-0.03em] min-w-[80px]">Real-time</div>
                  <div className="text-[0.78rem] text-white/50">Data flow between tools</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-[1200px] mx-auto px-4 md:px-8">
          <div className="text-center max-w-[640px] mx-auto mb-12">
            ...
            <h2 className="text-[clamp(1.6rem,3vw,2.2rem)] font-extrabold tracking-[-0.03em] leading-[1.12] mb-3.5 text-[#1C2E4A]">
              ...
              <span className="text-[#0E9BF0]">Connect Your Stack</span>
            </h2>
            <p className="text-[0.9rem] font-light text-[#4A5568] leading-relaxed max-w-[580px] mx-auto">
              Your tools should work together. We build reliable integrations that keep your data flowing and your team productive.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
            <div>
              ...
              <h2 className="text-[clamp(1.6rem,3vw,2.2rem)] font-extrabold tracking-[-0.03em] leading-[1.12] mb-4 text-[#1C2E4A]">
                Are Integrations & API Development<br />
              ...
              <p className="text-[0.9rem] font-light text-[#4A5568] leading-relaxed mb-4">
                If you're using multiple tools that don't talk to each other, you're wasting hours on manual data entry. Integrations automate the flow of information between your systems, saving time and eliminating errors.
              </p>
              <p className="text-[0.9rem] font-light text-[#4A5568] leading-relaxed mb-4">
            ...
            <div>
              <div className="bg-[#1C2E4A] rounded-2xl p-8 text-white">
                <h3 className="text-[1.1rem] font-bold mb-4">The Cost of Disconnected Tools</h3>
                <p className="text-[0.85rem] font-light text-white/60 leading-relaxed mb-3">Without integrations, your team spends hours copying data between systems. Errors creep in. Information gets lost. Decisions are made on outdated data.</p>
                <p className="text-[0.85rem] font-light text-white/60 leading-relaxed mb-5">Our integrations connect your entire tech stack. Data flows automatically between tools. Your team focuses on work, not data entry.</p>
                <div className="flex items-center gap-3 py-3 border-t border-white/10">
                  <div className="text-[1.3rem] font-extrabold text-[#F8D000] min-w-[70px]">10+</div>
                  <div className="text-[0.78rem] text-white/50">Hours saved weekly on data entry</div>
                </div>
                <div className="flex items-center gap-3 py-3 border-t border-white/10">
                  <div className="text-[1.3rem] font-extrabold text-[#F8D000] min-w-[70px]">100%</div>
                  <div className="text-[0.78rem] text-white/50">Data accuracy with automated sync</div>
                </div>
                <div className="flex items-center gap-3 py-3 border-t border-white/10">
                  <div className="text-[1.3rem] font-extrabold text-[#F8D000] min-w-[70px]">Real-time</div>
                  <div className="text-[0.78rem] text-white/50">Updates across all your tools</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-[1200px] mx-auto px-4 md:px-8">
          <div className="max-w-[600px] mb-12">
            ...
            <h2 className="text-[clamp(1.6rem,3vw,2.2rem)] font-extrabold tracking-[-0.03em] leading-[1.12] mb-3.5 text-[#1C2E4A]">
              ...
              <span className="text-[#0E9BF0]">Tech Stack</span>
            </h2>
            <p className="text-[0.9rem] font-light text-[#4A5568] leading-relaxed">A methodical approach to building reliable integrations that never break.</p>
          </div>
      ...
      <div className="bg-[#1C2E4A] py-16 text-center text-white relative overflow-hidden">
        ...
        <div className="max-w-[1200px] mx-auto px-4 md:px-8 relative z-10">
          <h2 className="text-[clamp(1.6rem,3vw,2.2rem)] font-extrabold tracking-[-0.03em] leading-[1.15] mb-3.5">
            ...
            <span className="text-[#F8D000]">Tech Stack?</span>
          </h2>
          <p className="text-[0.9rem] font-light text-white/50 max-w-[520px] mx-auto mb-7 leading-relaxed">
            Book a free integration consultation. We'll map your current tools, identify automation opportunities, and show you how to save hours of manual work.
          </p>
        ...
        <div className="max-w-[1200px] mx-auto px-4 md:px-8">
          <div className="text-center max-w-[600px] mx-auto mb-12">
            ...
            <h2 className="text-[clamp(1.6rem,3vw,2.2rem)] font-extrabold tracking-[-0.03em] leading-[1.12] mb-3.5 text-[#1C2E4A]">
              ...
              <span className="text-[#0E9BF0]">Integrations & API</span>
            </h2>
          </div>
