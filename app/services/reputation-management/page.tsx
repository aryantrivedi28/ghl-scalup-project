          ...
          <div className="grid md:grid-cols-[1.2fr_0.8fr] gap-10 md:gap-14 items-center">
            ...
            <div>
              <div className="bg-white/10 border border-white/15 rounded-2xl p-6 md:p-8">
                <h3 className="text-[0.68rem] font-bold uppercase tracking-[0.08em] text-white/50 mb-5">Reputation Results</h3>
                <div className="flex items-center gap-4 py-3 border-b border-white/10">
                  <div className="text-[1.4rem] font-extrabold text-[#F8D000] tracking-[-0.03em] min-w-[80px]">3x</div>
                  <div className="text-[0.78rem] text-white/50">More reviews with automated requests</div>
                </div>
                <div className="flex items-center gap-4 py-3 border-b border-white/10">
                  <div className="text-[1.4rem] font-extrabold text-[#F8D000] tracking-[-0.03em] min-w-[80px]">4.8</div>
                  <div className="text-[0.78rem] text-white/50">Average rating across clients</div>
                </div>
                <div className="flex items-center gap-4 py-3 border-b border-white/10">
                  <div className="text-[1.4rem] font-extrabold text-[#F8D000] tracking-[-0.03em] min-w-[80px]">24/7</div>
                  <div className="text-[0.78rem] text-white/50">Review monitoring & alerts</div>
                </div>
                <div className="flex items-center gap-4 py-3">
                  <div className="text-[1.4rem] font-extrabold text-[#F8D000] tracking-[-0.03em] min-w-[80px]">AI</div>
                  <div className="text-[0.78rem] text-white/50">Automated review responses</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-[1200px] mx-auto px-4 md:px-8">
          <div className="text-center max-w-[640px] mx-auto mb-12">
            ...
            <h2 className="text-[clamp(1.6rem,3vw,2.2rem)] font-extrabold tracking-[-0.03em] leading-[1.12] mb-3.5 text-[#1C2E4A]">
              ...
              <span className="text-[#0E9BF0]">5-Star Reputation</span>
            </h2>
            <p className="text-[0.9rem] font-light text-[#4A5568] leading-relaxed max-w-[580px] mx-auto">
              Your online reputation is your most valuable asset. We help you get more reviews, monitor what people say, and respond automatically.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
            <div>
              ...
              <p className="text-[0.9rem] font-light text-[#4A5568] leading-relaxed mb-4">
                93% of consumers read online reviews before making a purchase. A 1-star increase in your rating can increase revenue by 5-9%. Your reputation directly impacts your bottom line.
              </p>
              <p className="text-[0.9rem] font-light text-[#4A5568] leading-relaxed mb-4">
            ...
            <div>
              <div className="bg-[#1C2E4A] rounded-2xl p-8 text-white">
                <h3 className="text-[1.1rem] font-bold mb-4">The Cost of Poor Reputation</h3>
                <p className="text-[0.85rem] font-light text-white/60 leading-relaxed mb-3">68% of consumers will pay more for products from businesses with good reviews. A single negative review can cost you up to 30% of potential customers.</p>
                <p className="text-[0.85rem] font-light text-white/60 leading-relaxed mb-5">Our reputation management system helps you get more 5-star reviews, respond to every review professionally, and turn negative experiences into opportunities.</p>
                <div className="flex items-center gap-3 py-3 border-t border-white/10">
                  <div className="text-[1.3rem] font-extrabold text-[#F8D000] min-w-[70px]">93%</div>
                  <div className="text-[0.78rem] text-white/50">Consumers read reviews before buying</div>
                </div>
                <div className="flex items-center gap-3 py-3 border-t border-white/10">
                  <div className="text-[1.3rem] font-extrabold text-[#F8D000] min-w-[70px]">5-9%</div>
                  <div className="text-[0.78rem] text-white/50">Revenue increase per star rating</div>
                </div>
                <div className="flex items-center gap-3 py-3 border-t border-white/10">
                  <div className="text-[1.3rem] font-extrabold text-[#F8D000] min-w-[70px]">30%</div>
                  <div className="text-[0.78rem] text-white/50">Potential customers lost per negative review</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-[1200px] mx-auto px-4 md:px-8">
          <div className="max-w-[600px] mb-12">
            ...
            <h2 className="text-[clamp(1.6rem,3vw,2.2rem)] font-extrabold tracking-[-0.03em] leading-[1.12] mb-3.5 text-[#1C2E4A]">
              ...
              <span className="text-[#0E9BF0]">Reputation System</span>
            </h2>
            <p className="text-[0.9rem] font-light text-[#4A5568] leading-relaxed">A systematic approach to building a reputation system that attracts more customers.</p>
          </div>
          <div className="flex flex-col">
            {[
              { title: 'Review Flow Design', description: 'We design automated review request sequences triggered after purchase, service completion, or key milestones. Happy customers review when you ask.' },
      ...
      <div className="bg-[#1C2E4A] py-16 text-center text-white relative overflow-hidden">
        ...
        <div className="max-w-[1200px] mx-auto px-4 md:px-8 relative z-10">
          <h2 className="text-[clamp(1.6rem,3vw,2.2rem)] font-extrabold tracking-[-0.03em] leading-[1.15] mb-3.5">
            Ready to Turn Your Reputation<br />
            <span className="text-[#F8D000]">Into Your Best Salesperson?</span>
          </h2>
          <p className="text-[0.9rem] font-light text-white/50 max-w-[520px] mx-auto mb-7 leading-relaxed">
            Book a free reputation audit. We'll show you how to get more 5-star reviews, monitor your online reputation, and respond professionally to every review.
          </p>
        ...
        <div className="max-w-[1200px] mx-auto px-4 md:px-8">
          <div className="text-center max-w-[600px] mx-auto mb-12">
            ...
            <h2 className="text-[clamp(1.6rem,3vw,2.2rem)] font-extrabold tracking-[-0.03em] leading-[1.12] mb-3.5 text-[#1C2E4A]">
              ...
              <span className="text-[#0E9BF0]">Reputation Management</span>
            </h2>
          </div>
      ...
      <section className="py-16 md:py-20 bg-[#F4F7FA]">
        <div className="max-w-[1200px] mx-auto px-4 md:px-8">
          <div className="text-center max-w-[600px] mx-auto mb-10">
            ...
            <h2 className="text-[clamp(1.6rem,3vw,2.2rem)] font-extrabold tracking-[-0.03em] leading-[1.12] mb-3.5 text-[#1C2E4A]">
              Maximize Your Reputation<br />
              <span className="text-[#0E9BF0]">With These Services</span>
            </h2>
          </div>
          <div className="grid md:grid-cols-3 gap-5">
            {[
              { title: 'CRM Setup', description: 'Capture and manage customers who leave reviews. Track review history and follow up with reviewers.', href: '/services/ghl/crm-setup' },
              { title: 'Workflow Automation', description: 'Automate review request sequences based on purchase or service completion triggers.', href: '/services/ghl/workflow-automation' },
              { title: 'Email & SMS Campaigns', description: 'Send review requests via email and SMS at the perfect moment for maximum response.', href: '/services/ghl/email-sms-whatsapp' },
            ].map((service, index) => (
