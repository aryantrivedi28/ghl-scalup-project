  ...
  const handlePayment = useCallback(async () => {
    ...
    try {
      ...
      const options = {
        ...
        amount: data.amount,
        currency: data.currency, // Should be 'USD'
        name: 'GHL ScaleUp',
    ...
    <div className="w-full">
      ...
      {process.env.NODE_ENV === 'development' && (
        <div className="mt-4 p-3 bg-[rgba(248,208,0,0.03)] border border-[rgba(248,208,0,0.05)] rounded-lg">
          <p className="text-white/30 text-[10px] uppercase tracking-wider mb-1">💳 Test Card</p>
