...
export const faqData: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "GoHighLevel has three pricing tiers: Starter at $97/month (solo operators, single business), Unlimited at $297/month (agencies with multiple sub-accounts and white-labeling), and Agency Pro / SaaS Pro at $497/month (agencies reselling GHL as their own branded SaaS). All plans include unlimited contacts, unlimited users, and a 14-day free trial with no credit card required. Usage-based fees for SMS, email, AI, and phone calls are charged separately. GHL Scale Up helps you pick the right plan for your business stage and configure it so you actually use what you are paying for."
  },
  {
    question: "Who uses GoHighLevel?",
    answer: "GoHighLevel is used by over 1 million businesses worldwide. The most common users are digital marketing agencies managing multiple client accounts, SaaS entrepreneurs reselling white-label software, service businesses like real estate, home services, legal, medical, fitness, and dental practices, coaches and consultants automating their client communication, and ecommerce brands integrating GHL with Shopify or WooCommerce. If you fall into any of these categories, we have built GHL systems for businesses exactly like yours. Check our case studies to see real examples."
  },
  {
    question: "Is GoHighLevel worth it in 2026?",
