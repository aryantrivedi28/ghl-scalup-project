...
export const blogPosts: BlogPost[] = [
      ...
      },
      {
            ...
            excerpt: 'Does GoHighLevel iMessage require a Mac and iPhone? Compare owned hardware, cloud Mac, and managed providers, and what happens when infrastructure goes offline.',
            slug: 'gohighlevel-imessage-mac-iphone',
      ...
      },
      {
            icon: 'RotateCcw',
            tag: 'Troubleshooting',
            title: 'GoHighLevel Workflow Re-Entry Explained',
            excerpt: 'Why won\'t a GoHighLevel contact enter a workflow again? Learn how Allow Re-entry actually works, its trigger-specific exceptions, and how to troubleshoot it.',
            slug: 'gohighlevel-workflow-reentry',
      ...
      },
      {
            ...
            excerpt: 'GoHighLevel workflow not triggering? Check trigger filters, test with a fresh contact, and use Enrollment History to find exactly where it\'s failing.',
            slug: 'gohighlevel-workflow-not-triggering',
      ...
      },
      {
            ...
            excerpt: 'Kajabi vs GoHighLevel compared honestly courses, CRM, automation, pricing, and agency use. Find out which platform actually fits your business model.',
            slug: 'kajabi-vs-gohighlevel',
